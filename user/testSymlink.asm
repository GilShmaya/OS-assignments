...
user/_testSymlink:     file format elf64-littleriscv
...
main(){
   ...
   c:	82058593          	addi	a1,a1,-2016 # 828 <malloc+0xe8>
  10:	00001517          	auipc	a0,0x1
  14:	82050513          	addi	a0,a0,-2016 # 830 <malloc+0xf0>
  18:	00000097          	auipc	ra,0x0
  1c:	34a080e7          	jalr	842(ra) # 362 <symlink>
    struct stat st;
    char buf[256];
    readlink(newpath, buf, 256);
  20:	10000613          	li	a2,256
  24:	ed840593          	addi	a1,s0,-296
  28:	00001517          	auipc	a0,0x1
  2c:	80050513          	addi	a0,a0,-2048 # 828 <malloc+0xe8>
  30:	00000097          	auipc	ra,0x0
  34:	33a080e7          	jalr	826(ra) # 36a <readlink>
    int fd = open(newpath, O_RDONLY | O_NOFOLLOW);
  38:	4591                	li	a1,4
  3a:	00000517          	auipc	a0,0x0
  3e:	7ee50513          	addi	a0,a0,2030 # 828 <malloc+0xe8>
  42:	00000097          	auipc	ra,0x0
  46:	2f8080e7          	jalr	760(ra) # 33a <open>
    fstat(fd, &st);
  4a:	fd840593          	addi	a1,s0,-40
  4e:	00000097          	auipc	ra,0x0
  52:	304080e7          	jalr	772(ra) # 352 <fstat>
    printf("%s %d %d %d\n", newpath, st.type, st.ino, st.size);
  56:	fe843703          	ld	a4,-24(s0)
  5a:	fdc42683          	lw	a3,-36(s0)
  5e:	fe041603          	lh	a2,-32(s0)
  62:	00000597          	auipc	a1,0x0
  66:	7c658593          	addi	a1,a1,1990 # 828 <malloc+0xe8>
  6a:	00000517          	auipc	a0,0x0
  6e:	7ce50513          	addi	a0,a0,1998 # 838 <malloc+0xf8>
  72:	00000097          	auipc	ra,0x0
  76:	610080e7          	jalr	1552(ra) # 682 <printf>
...
free(void *ap)
{
 ...
 6c6:	1a67b783          	ld	a5,422(a5) # 868 <freep>
 ...
 6f4:	00e6ea63          	bltu	a3,a4,708 <free+0x50>
{
 ...
 736:	12f73b23          	sd	a5,310(a4) # 868 <freep>
}
 73a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 768:	10453503          	ld	a0,260(a0) # 868 <freep>
 ...
 790:	0dc90913          	addi	s2,s2,220 # 868 <freep>
  if(p == (char*)-1)
 794:	5afd                	li	s5,-1
 796:	a88d                	j	808 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 798:	00000797          	auipc	a5,0x0
 79c:	0d878793          	addi	a5,a5,216 # 870 <base>
 7a0:	00000717          	auipc	a4,0x0
 7a4:	0cf73423          	sd	a5,200(a4) # 868 <freep>
 7a8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ca:	0aa73123          	sd	a0,162(a4) # 868 <freep>
      return (void*)(p + 1);
