...
void cas_test(int size, int interval, char* env_name) {
   ...
   c:	324080e7          	jalr	804(ra) # 32c <fork>
       if (pid != 0){
  ...
  2a:	84250513          	addi	a0,a0,-1982 # 868 <malloc+0xe6>
  2e:	00000097          	auipc	ra,0x0
  32:	696080e7          	jalr	1686(ra) # 6c4 <printf>
           pid = fork();
  36:	00000097          	auipc	ra,0x0
  3a:	2f6080e7          	jalr	758(ra) # 32c <fork>
           if (pid != 0)
  3e:	d971                	beqz	a0,12 <cas_test+0x12>
            printf("PID: %d\n", pid);
  40:	85aa                	mv	a1,a0
  42:	00001517          	auipc	a0,0x1
  46:	82650513          	addi	a0,a0,-2010 # 868 <malloc+0xe6>
  4a:	00000097          	auipc	ra,0x0
  4e:	67a080e7          	jalr	1658(ra) # 6c4 <printf>
  ...
  62:	666080e7          	jalr	1638(ra) # 6c4 <printf>
           pid = fork();
  66:	00000097          	auipc	ra,0x0
  6a:	2c6080e7          	jalr	710(ra) # 32c <fork>
           if (pid != 0)
  6e:	d55d                	beqz	a0,1c <cas_test+0x1c>
            printf("PID: %d\n", pid);
  70:	85aa                	mv	a1,a0
  72:	00000517          	auipc	a0,0x0
  76:	7f650513          	addi	a0,a0,2038 # 868 <malloc+0xe6>
...
void env() {
  ...
  90:	2a0080e7          	jalr	672(ra) # 32c <fork>
...
00000000000003e4 <cpu_process_count>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 434:	45050513          	addi	a0,a0,1104 # 880 <digits>
 438:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	384b8b93          	addi	s7,s7,900 # 880 <digits>
 ...
 640:	23c90913          	addi	s2,s2,572 # 878 <malloc+0xf6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 708:	1947b783          	ld	a5,404(a5) # 898 <freep>
 ...
 736:	00e6ea63          	bltu	a3,a4,74a <free+0x50>
{
 ...
 778:	12f73223          	sd	a5,292(a4) # 898 <freep>
}
 77c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7aa:	0f253503          	ld	a0,242(a0) # 898 <freep>
 ...
 7d2:	0ca90913          	addi	s2,s2,202 # 898 <freep>
  if(p == (char*)-1)
 7d6:	5afd                	li	s5,-1
 7d8:	a88d                	j	84a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7da:	00000797          	auipc	a5,0x0
 7de:	0c678793          	addi	a5,a5,198 # 8a0 <base>
 7e2:	00000717          	auipc	a4,0x0
 7e6:	0af73b23          	sd	a5,182(a4) # 898 <freep>
 7ea:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 80c:	08a73823          	sd	a0,144(a4) # 898 <freep>
      return (void*)(p + 1);
