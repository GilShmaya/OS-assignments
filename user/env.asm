...
void env(int size, int interval, char* env_name) {
  ...
  2a:	85a50513          	addi	a0,a0,-1958 # 880 <malloc+0xe4>
  2e:	00000097          	auipc	ra,0x0
  32:	6b0080e7          	jalr	1712(ra) # 6de <printf>
           pid = fork();
  ...
  46:	83e50513          	addi	a0,a0,-1986 # 880 <malloc+0xe4>
  4a:	00000097          	auipc	ra,0x0
  4e:	694080e7          	jalr	1684(ra) # 6de <printf>
  52:	b7c1                	j	12 <env+0x12>
           printf("PID: %d\n", pid);
  54:	85aa                	mv	a1,a0
  56:	00001517          	auipc	a0,0x1
  5a:	82a50513          	addi	a0,a0,-2006 # 880 <malloc+0xe4>
  5e:	00000097          	auipc	ra,0x0
  62:	680080e7          	jalr	1664(ra) # 6de <printf>
           pid = fork();
  ...
  76:	80e50513          	addi	a0,a0,-2034 # 880 <malloc+0xe4>
  7a:	00000097          	auipc	ra,0x0
  7e:	664080e7          	jalr	1636(ra) # 6de <printf>
}
...
void env_large() {
  ...
  90:	80460613          	addi	a2,a2,-2044 # 890 <malloc+0xf4>
  94:	009895b7          	lui	a1,0x989
  98:	68058593          	addi	a1,a1,1664 # 989680 <__global_pointer$+0x9885b7>
  9c:	852e                	mv	a0,a1
...
void env_freq() {
  ...
  b6:	00000617          	auipc	a2,0x0
  ba:	7ea60613          	addi	a2,a2,2026 # 8a0 <malloc+0x104>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44e:	46e50513          	addi	a0,a0,1134 # 8b8 <digits>
 452:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51a:	3a2b8b93          	addi	s7,s7,930 # 8b8 <digits>
 ...
 65a:	25a90913          	addi	s2,s2,602 # 8b0 <malloc+0x114>
        while(*s != 0){
...
free(void *ap)
{
 ...
 722:	1b27b783          	ld	a5,434(a5) # 8d0 <freep>
 ...
 750:	00e6ea63          	bltu	a3,a4,764 <free+0x50>
{
 ...
 792:	14f73123          	sd	a5,322(a4) # 8d0 <freep>
}
 796:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c4:	11053503          	ld	a0,272(a0) # 8d0 <freep>
 ...
 7ec:	0e890913          	addi	s2,s2,232 # 8d0 <freep>
  if(p == (char*)-1)
 7f0:	5afd                	li	s5,-1
 7f2:	a88d                	j	864 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7f4:	00000797          	auipc	a5,0x0
 7f8:	0e478793          	addi	a5,a5,228 # 8d8 <base>
 7fc:	00000717          	auipc	a4,0x0
 800:	0cf73a23          	sd	a5,212(a4) # 8d0 <freep>
 804:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 826:	0aa73723          	sd	a0,174(a4) # 8d0 <freep>
      return (void*)(p + 1);
