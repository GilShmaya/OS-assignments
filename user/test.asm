...
void example_pause_system(int interval, int pause_seconds, int loop_size) {
  ...
  30:	834b0b13          	addi	s6,s6,-1996 # 860 <malloc+0xe6>
  34:	a829                	j	4e <example_pause_system+0x4e>
  36:	864a                	mv	a2,s2
  38:	85a6                	mv	a1,s1
  3a:	855a                	mv	a0,s6
  3c:	00000097          	auipc	ra,0x0
  40:	680080e7          	jalr	1664(ra) # 6bc <printf>
        if (i == x){
  ...
  66:	81e50513          	addi	a0,a0,-2018 # 880 <malloc+0x106>
  6a:	00000097          	auipc	ra,0x0
  6e:	652080e7          	jalr	1618(ra) # 6bc <printf>
...
int main(int argc, char** argv){
  ...
  9a:	7f298993          	addi	s3,s3,2034 # 888 <malloc+0x10e>
    for(int i=1; i<1000; i++){
  ...
  aa:	616080e7          	jalr	1558(ra) # 6bc <printf>
    for(int i=1; i<1000; i++){
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42c:	47050513          	addi	a0,a0,1136 # 898 <digits>
 430:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	3a4b8b93          	addi	s7,s7,932 # 898 <digits>
 ...
 638:	25c90913          	addi	s2,s2,604 # 890 <malloc+0x116>
        while(*s != 0){
...
free(void *ap)
{
 ...
 700:	1b47b783          	ld	a5,436(a5) # 8b0 <freep>
 ...
 72e:	00e6ea63          	bltu	a3,a4,742 <free+0x50>
{
 ...
 770:	14f73223          	sd	a5,324(a4) # 8b0 <freep>
}
 774:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7a2:	11253503          	ld	a0,274(a0) # 8b0 <freep>
 ...
 7ca:	0ea90913          	addi	s2,s2,234 # 8b0 <freep>
  if(p == (char*)-1)
 7ce:	5afd                	li	s5,-1
 7d0:	a88d                	j	842 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7d2:	00000797          	auipc	a5,0x0
 7d6:	0e678793          	addi	a5,a5,230 # 8b8 <base>
 7da:	00000717          	auipc	a4,0x0
 7de:	0cf73b23          	sd	a5,214(a4) # 8b0 <freep>
 7e2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
