...
void example_pause_system(int interval, int pause_seconds, int loop_size) {
  ...
  12:	0080                	addi	s0,sp,64
    ...
    int n= loop_size;
    for (int i = 0; i < n; i++) {
  14:	04c05763          	blez	a2,62 <example_pause_system+0x62>
  18:	8a2a                	mv	s4,a0
  1a:	8aae                	mv	s5,a1
  1c:	8932                	mv	s2,a2
        ...
        int x = n/2;
  1e:	01f6599b          	srliw	s3,a2,0x1f
  22:	00c989bb          	addw	s3,s3,a2
  26:	4019d99b          	sraiw	s3,s3,0x1
    for (int i = 0; i < n; i++) {
  2a:	4481                	li	s1,0
            printf("pause system %d/%d completed.\n", i, n);
  2c:	00001b17          	auipc	s6,0x1
  30:	83cb0b13          	addi	s6,s6,-1988 # 868 <malloc+0xe6>
  34:	a829                	j	4e <example_pause_system+0x4e>
  36:	864a                	mv	a2,s2
  38:	85a6                	mv	a1,s1
  3a:	855a                	mv	a0,s6
  3c:	00000097          	auipc	ra,0x0
  40:	688080e7          	jalr	1672(ra) # 6c4 <printf>
        if (i == x){
  44:	00998963          	beq	s3,s1,56 <example_pause_system+0x56>
    for (int i = 0; i < n; i++) {
  48:	2485                	addiw	s1,s1,1
  4a:	00990c63          	beq	s2,s1,62 <example_pause_system+0x62>
        if (i % interval == 0)
  4e:	0344e7bb          	remw	a5,s1,s4
  52:	fbed                	bnez	a5,44 <example_pause_system+0x44>
  54:	b7cd                	j	36 <example_pause_system+0x36>
            pause_system(pause_seconds);
  56:	8556                	mv	a0,s5
  58:	00000097          	auipc	ra,0x0
  5c:	37c080e7          	jalr	892(ra) # 3d4 <pause_system>
  60:	b7e5                	j	48 <example_pause_system+0x48>
        }
  ...
  66:	82650513          	addi	a0,a0,-2010 # 888 <malloc+0x106>
  6a:	00000097          	auipc	ra,0x0
  6e:	65a080e7          	jalr	1626(ra) # 6c4 <printf>
...
int main(int argc, char** argv){
  ...
  94:	4485                	li	s1,1
        printf("%d",i);
  96:	00000997          	auipc	s3,0x0
  9a:	7fa98993          	addi	s3,s3,2042 # 890 <malloc+0x10e>
    for(int i=1; i<1000; i++){
  9e:	3e800913          	li	s2,1000
        printf("%d",i);
  a2:	85a6                	mv	a1,s1
  a4:	854e                	mv	a0,s3
  a6:	00000097          	auipc	ra,0x0
  aa:	61e080e7          	jalr	1566(ra) # 6c4 <printf>
    for(int i=1; i<1000; i++){
  ae:	2485                	addiw	s1,s1,1
  b0:	ff2499e3          	bne	s1,s2,a2 <main+0x1c>
    }
    exit(0);
  b4:	4501                	li	a0,0
  b6:	00000097          	auipc	ra,0x0
  ba:	27e080e7          	jalr	638(ra) # 334 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 434:	47050513          	addi	a0,a0,1136 # 8a0 <digits>
 438:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	3a4b8b93          	addi	s7,s7,932 # 8a0 <digits>
 ...
 640:	25c90913          	addi	s2,s2,604 # 898 <malloc+0x116>
        while(*s != 0){
...
free(void *ap)
{
 ...
 708:	1b47b783          	ld	a5,436(a5) # 8b8 <freep>
 ...
 736:	00e6ea63          	bltu	a3,a4,74a <free+0x50>
{
 ...
 778:	14f73223          	sd	a5,324(a4) # 8b8 <freep>
}
 77c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7aa:	11253503          	ld	a0,274(a0) # 8b8 <freep>
 ...
 7d2:	0ea90913          	addi	s2,s2,234 # 8b8 <freep>
  if(p == (char*)-1)
 7d6:	5afd                	li	s5,-1
 7d8:	a88d                	j	84a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7da:	00000797          	auipc	a5,0x0
 7de:	0e678793          	addi	a5,a5,230 # 8c0 <base>
 7e2:	00000717          	auipc	a4,0x0
 7e6:	0cf73b23          	sd	a5,214(a4) # 8b8 <freep>
 7ea:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 80c:	0aa73823          	sd	a0,176(a4) # 8b8 <freep>
      return (void*)(p + 1);
