...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	09250513          	addi	a0,a0,146 # 60d0 <malloc+0x446>
      ...
      74:	8082                	ret
{
      ...
      84:	07050513          	addi	a0,a0,112 # 60f0 <malloc+0x466>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	06050513          	addi	a0,a0,96 # 6108 <malloc+0x47e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	06250513          	addi	a0,a0,98 # 6128 <malloc+0x49e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	02a50513          	addi	a0,a0,42 # 6110 <malloc+0x486>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	03650513          	addi	a0,a0,54 # 6138 <malloc+0x4ae>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	03450513          	addi	a0,a0,52 # 6160 <malloc+0x4d6>
     134:	00005097          	auipc	ra,0x5
     138:	770080e7          	jalr	1904(ra) # 58a4 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	02050513          	addi	a0,a0,32 # 6160 <malloc+0x4d6>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	01c58593          	addi	a1,a1,28 # 6170 <malloc+0x4e6>
     15c:	00005097          	auipc	ra,0x5
     160:	718080e7          	jalr	1816(ra) # 5874 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ff850513          	addi	a0,a0,-8 # 6160 <malloc+0x4d6>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	ffc58593          	addi	a1,a1,-4 # 6178 <malloc+0x4ee>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fcc50513          	addi	a0,a0,-52 # 6160 <malloc+0x4d6>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fb650513          	addi	a0,a0,-74 # 6180 <malloc+0x4f6>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	cd450513          	addi	a0,a0,-812 # 5f50 <malloc+0x2c6>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	cc0a8a93          	addi	s5,s5,-832 # 5f50 <malloc+0x2c6>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	e9650513          	addi	a0,a0,-362 # 61a8 <malloc+0x51e>
     ...
     33a:	e9250513          	addi	a0,a0,-366 # 61c8 <malloc+0x53e>
     33e:	00006097          	auipc	ra,0x6
     342:	88e080e7          	jalr	-1906(ra) # 5bcc <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	e6ea0a13          	addi	s4,s4,-402 # 61e0 <malloc+0x556>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	dca50513          	addi	a0,a0,-566 # 61e8 <malloc+0x55e>
     426:	00005097          	auipc	ra,0x5
     42a:	7a6080e7          	jalr	1958(ra) # 5bcc <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	dc450513          	addi	a0,a0,-572 # 6200 <malloc+0x576>
     444:	00005097          	auipc	ra,0x5
     448:	788080e7          	jalr	1928(ra) # 5bcc <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	dd650513          	addi	a0,a0,-554 # 6230 <malloc+0x5a6>
     462:	00005097          	auipc	ra,0x5
     466:	76a080e7          	jalr	1898(ra) # 5bcc <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	dec50513          	addi	a0,a0,-532 # 6260 <malloc+0x5d6>
     47c:	00005097          	auipc	ra,0x5
     480:	750080e7          	jalr	1872(ra) # 5bcc <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	dde50513          	addi	a0,a0,-546 # 6270 <malloc+0x5e6>
     49a:	00005097          	auipc	ra,0x5
     49e:	732080e7          	jalr	1842(ra) # 5bcc <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	dd0a0a13          	addi	s4,s4,-560 # 62a0 <malloc+0x616>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	ca0a8a93          	addi	s5,s5,-864 # 6178 <malloc+0x4ee>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d2a50513          	addi	a0,a0,-726 # 62a8 <malloc+0x61e>
     586:	00005097          	auipc	ra,0x5
     58a:	646080e7          	jalr	1606(ra) # 5bcc <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d2450513          	addi	a0,a0,-732 # 62c0 <malloc+0x636>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	628080e7          	jalr	1576(ra) # 5bcc <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	caa50513          	addi	a0,a0,-854 # 6260 <malloc+0x5d6>
     5be:	00005097          	auipc	ra,0x5
     5c2:	60e080e7          	jalr	1550(ra) # 5bcc <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d2050513          	addi	a0,a0,-736 # 62f0 <malloc+0x666>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	5f4080e7          	jalr	1524(ra) # 5bcc <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d1a50513          	addi	a0,a0,-742 # 6308 <malloc+0x67e>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	5d6080e7          	jalr	1494(ra) # 5bcc <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b2c58593          	addi	a1,a1,-1236 # 6170 <malloc+0x4e6>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b0050513          	addi	a0,a0,-1280 # 6160 <malloc+0x4d6>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	ad450513          	addi	a0,a0,-1324 # 6160 <malloc+0x4d6>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	ac050513          	addi	a0,a0,-1344 # 6160 <malloc+0x4d6>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	cba58593          	addi	a1,a1,-838 # 6398 <malloc+0x70e>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a4050513          	addi	a0,a0,-1472 # 6160 <malloc+0x4d6>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	bd450513          	addi	a0,a0,-1068 # 6338 <malloc+0x6ae>
     76c:	00005097          	auipc	ra,0x5
     770:	460080e7          	jalr	1120(ra) # 5bcc <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	bd850513          	addi	a0,a0,-1064 # 6358 <malloc+0x6ce>
     788:	00005097          	auipc	ra,0x5
     78c:	444080e7          	jalr	1092(ra) # 5bcc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	bd450513          	addi	a0,a0,-1068 # 6368 <malloc+0x6de>
     79c:	00005097          	auipc	ra,0x5
     7a0:	430080e7          	jalr	1072(ra) # 5bcc <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	bd850513          	addi	a0,a0,-1064 # 6388 <malloc+0x6fe>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	414080e7          	jalr	1044(ra) # 5bcc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	ba450513          	addi	a0,a0,-1116 # 6368 <malloc+0x6de>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	400080e7          	jalr	1024(ra) # 5bcc <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	bbe50513          	addi	a0,a0,-1090 # 63a0 <malloc+0x716>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	3e2080e7          	jalr	994(ra) # 5bcc <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	bc050513          	addi	a0,a0,-1088 # 63c0 <malloc+0x736>
     808:	00005097          	auipc	ra,0x5
     80c:	3c4080e7          	jalr	964(ra) # 5bcc <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	bac50513          	addi	a0,a0,-1108 # 63e0 <malloc+0x756>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	bbc98993          	addi	s3,s3,-1092 # 6408 <malloc+0x77e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	beca8a93          	addi	s5,s5,-1044 # 6440 <malloc+0x7b6>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b4650513          	addi	a0,a0,-1210 # 63e0 <malloc+0x756>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b0a50513          	addi	a0,a0,-1270 # 63e0 <malloc+0x756>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	ae850513          	addi	a0,a0,-1304 # 63e8 <malloc+0x75e>
     908:	00005097          	auipc	ra,0x5
     90c:	2c4080e7          	jalr	708(ra) # 5bcc <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	afa50513          	addi	a0,a0,-1286 # 6418 <malloc+0x78e>
     926:	00005097          	auipc	ra,0x5
     92a:	2a6080e7          	jalr	678(ra) # 5bcc <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b1450513          	addi	a0,a0,-1260 # 6450 <malloc+0x7c6>
     944:	00005097          	auipc	ra,0x5
     948:	288080e7          	jalr	648(ra) # 5bcc <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b2050513          	addi	a0,a0,-1248 # 6478 <malloc+0x7ee>
     960:	00005097          	auipc	ra,0x5
     964:	26c080e7          	jalr	620(ra) # 5bcc <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b2450513          	addi	a0,a0,-1244 # 6498 <malloc+0x80e>
     97c:	00005097          	auipc	ra,0x5
     980:	250080e7          	jalr	592(ra) # 5bcc <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b2050513          	addi	a0,a0,-1248 # 64b0 <malloc+0x826>
     998:	00005097          	auipc	ra,0x5
     99c:	234080e7          	jalr	564(ra) # 5bcc <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b0e50513          	addi	a0,a0,-1266 # 64d0 <malloc+0x846>
  ...
  if(fd < 0){
    ...
    ((int*)buf)[0] = i;
     ...
     9de:	3b690913          	addi	s2,s2,950 # bd90 <buf>
  for(i = 0; i < MAXFILE; i++){
     9e2:	6a41                	lui	s4,0x10
     9e4:	10ba0a13          	addi	s4,s4,267 # 1010b <__BSS_END__+0x136b>
    ((int*)buf)[0] = i;
  ...
  fd = open("big", O_RDONLY);
     ...
     a1a:	aba50513          	addi	a0,a0,-1350 # 64d0 <malloc+0x846>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2e:	36690913          	addi	s2,s2,870 # bd90 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a62:	a7a50513          	addi	a0,a0,-1414 # 64d8 <malloc+0x84e>
     a66:	00005097          	auipc	ra,0x5
     a6a:	166080e7          	jalr	358(ra) # 5bcc <printf>
    exit(1);
     a6e:	4505                	li	a0,1
     ...
     a80:	a7c50513          	addi	a0,a0,-1412 # 64f8 <malloc+0x86e>
     a84:	00005097          	auipc	ra,0x5
     a88:	148080e7          	jalr	328(ra) # 5bcc <printf>
      exit(1);
     a8c:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9c:	a8850513          	addi	a0,a0,-1400 # 6520 <malloc+0x896>
     aa0:	00005097          	auipc	ra,0x5
     aa4:	12c080e7          	jalr	300(ra) # 5bcc <printf>
    exit(1);
     aa8:	4505                	li	a0,1
     ...
     ab4:	10a78793          	addi	a5,a5,266 # 1010a <__BSS_END__+0x136a>
  ...
  if(unlink("big") < 0){
     ...
     aca:	a0a50513          	addi	a0,a0,-1526 # 64d0 <malloc+0x846>
     ...
     af4:	a5050513          	addi	a0,a0,-1456 # 6540 <malloc+0x8b6>
     af8:	00005097          	auipc	ra,0x5
     afc:	0d4080e7          	jalr	212(ra) # 5bcc <printf>
        exit(1);
     b00:	4505                	li	a0,1
     ...
     b12:	a5a50513          	addi	a0,a0,-1446 # 6568 <malloc+0x8de>
     b16:	00005097          	auipc	ra,0x5
     b1a:	0b6080e7          	jalr	182(ra) # 5bcc <printf>
      exit(1);
     b1e:	4505                	li	a0,1
     ...
     b30:	a5450513          	addi	a0,a0,-1452 # 6580 <malloc+0x8f6>
     b34:	00005097          	auipc	ra,0x5
     b38:	098080e7          	jalr	152(ra) # 5bcc <printf>
      exit(1);
     b3c:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4c:	a6050513          	addi	a0,a0,-1440 # 65a8 <malloc+0x91e>
     b50:	00005097          	auipc	ra,0x5
     b54:	07c080e7          	jalr	124(ra) # 5bcc <printf>
    exit(1);
     b58:	4505                	li	a0,1
...
0000000000000b62 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b7a:	36a50513          	addi	a0,a0,874 # 5ee0 <malloc+0x256>
  ...
  write(fd, "hello", SZ);
     ...
     b92:	a5258593          	addi	a1,a1,-1454 # 65e0 <malloc+0x956>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bae:	33650513          	addi	a0,a0,822 # 5ee0 <malloc+0x256>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc4:	32050513          	addi	a0,a0,800 # 5ee0 <malloc+0x256>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bda:	30a50513          	addi	a0,a0,778 # 5ee0 <malloc+0x256>
  ...
  write(fd1, "yyy", 3);
     ...
     bee:	a3e58593          	addi	a1,a1,-1474 # 6628 <malloc+0x99e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c0a:	18a58593          	addi	a1,a1,394 # bd90 <buf>
     c0e:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c56:	28e50513          	addi	a0,a0,654 # 5ee0 <malloc+0x256>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c76:	94e50513          	addi	a0,a0,-1714 # 65c0 <malloc+0x936>
     c7a:	00005097          	auipc	ra,0x5
     c7e:	f52080e7          	jalr	-174(ra) # 5bcc <printf>
    exit(1);
     c82:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c92:	95a50513          	addi	a0,a0,-1702 # 65e8 <malloc+0x95e>
     c96:	00005097          	auipc	ra,0x5
     c9a:	f36080e7          	jalr	-202(ra) # 5bcc <printf>
    exit(1);
     c9e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cae:	95e50513          	addi	a0,a0,-1698 # 6608 <malloc+0x97e>
     cb2:	00005097          	auipc	ra,0x5
     cb6:	f1a080e7          	jalr	-230(ra) # 5bcc <printf>
    exit(1);
     cba:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cca:	96a50513          	addi	a0,a0,-1686 # 6630 <malloc+0x9a6>
     cce:	00005097          	auipc	ra,0x5
     cd2:	efe080e7          	jalr	-258(ra) # 5bcc <printf>
    exit(1);
     cd6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce6:	96e50513          	addi	a0,a0,-1682 # 6650 <malloc+0x9c6>
     cea:	00005097          	auipc	ra,0x5
     cee:	ee2080e7          	jalr	-286(ra) # 5bcc <printf>
    exit(1);
     cf2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d02:	97250513          	addi	a0,a0,-1678 # 6670 <malloc+0x9e6>
     d06:	00005097          	auipc	ra,0x5
     d0a:	ec6080e7          	jalr	-314(ra) # 5bcc <printf>
    exit(1);
     d0e:	4505                	li	a0,1
...
0000000000000d18 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d66:	87e58593          	addi	a1,a1,-1922 # 65e0 <malloc+0x956>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d86:	91658593          	addi	a1,a1,-1770 # 6698 <malloc+0xa0e>
     d8a:	00006517          	auipc	a0,0x6
     d8e:	90650513          	addi	a0,a0,-1786 # 6690 <malloc+0xa06>
  ...
  unlink("lf1");
     ...
     da2:	8f250513          	addi	a0,a0,-1806 # 6690 <malloc+0xa06>
     da6:	00005097          	auipc	ra,0x5
     daa:	afe080e7          	jalr	-1282(ra) # 58a4 <unlink>
  if(open("lf1", 0) >= 0){
     dae:	4581                	li	a1,0
     db0:	00006517          	auipc	a0,0x6
     db4:	8e050513          	addi	a0,a0,-1824 # 6690 <malloc+0xa06>
  ...
  fd = open("lf2", 0);
     ...
     dca:	8d250513          	addi	a0,a0,-1838 # 6698 <malloc+0xa0e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de2:	fb258593          	addi	a1,a1,-78 # bd90 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e02:	89a58593          	addi	a1,a1,-1894 # 6698 <malloc+0xa0e>
     e06:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e18:	88450513          	addi	a0,a0,-1916 # 6698 <malloc+0xa0e>
     e1c:	00005097          	auipc	ra,0x5
     e20:	a88080e7          	jalr	-1400(ra) # 58a4 <unlink>
  if(link("lf2", "lf1") >= 0){
     e24:	00006597          	auipc	a1,0x6
     e28:	86c58593          	addi	a1,a1,-1940 # 6690 <malloc+0xa06>
     e2c:	00006517          	auipc	a0,0x6
     e30:	86c50513          	addi	a0,a0,-1940 # 6698 <malloc+0xa0e>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e44:	85058593          	addi	a1,a1,-1968 # 6690 <malloc+0xa06>
     e48:	00006517          	auipc	a0,0x6
     e4c:	95850513          	addi	a0,a0,-1704 # 67a0 <malloc+0xb16>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6e:	83650513          	addi	a0,a0,-1994 # 66a0 <malloc+0xa16>
     e72:	00005097          	auipc	ra,0x5
     e76:	d5a080e7          	jalr	-678(ra) # 5bcc <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e8a:	83250513          	addi	a0,a0,-1998 # 66b8 <malloc+0xa2e>
     e8e:	00005097          	auipc	ra,0x5
     e92:	d3e080e7          	jalr	-706(ra) # 5bcc <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea6:	82e50513          	addi	a0,a0,-2002 # 66d0 <malloc+0xa46>
     eaa:	00005097          	auipc	ra,0x5
     eae:	d22080e7          	jalr	-734(ra) # 5bcc <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec2:	83250513          	addi	a0,a0,-1998 # 66f0 <malloc+0xa66>
     ec6:	00005097          	auipc	ra,0x5
     eca:	d06080e7          	jalr	-762(ra) # 5bcc <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     ede:	84650513          	addi	a0,a0,-1978 # 6720 <malloc+0xa96>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	cea080e7          	jalr	-790(ra) # 5bcc <printf>
    exit(1);
     eea:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     efa:	84250513          	addi	a0,a0,-1982 # 6738 <malloc+0xaae>
     efe:	00005097          	auipc	ra,0x5
     f02:	cce080e7          	jalr	-818(ra) # 5bcc <printf>
    exit(1);
     f06:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f16:	83e50513          	addi	a0,a0,-1986 # 6750 <malloc+0xac6>
     f1a:	00005097          	auipc	ra,0x5
     f1e:	cb2080e7          	jalr	-846(ra) # 5bcc <printf>
    exit(1);
     f22:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f32:	84a50513          	addi	a0,a0,-1974 # 6778 <malloc+0xaee>
     f36:	00005097          	auipc	ra,0x5
     f3a:	c96080e7          	jalr	-874(ra) # 5bcc <printf>
    exit(1);
     f3e:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4e:	85e50513          	addi	a0,a0,-1954 # 67a8 <malloc+0xb1e>
     f52:	00005097          	auipc	ra,0x5
     f56:	c7a080e7          	jalr	-902(ra) # 5bcc <printf>
    exit(1);
     f5a:	4505                	li	a0,1
...
0000000000000f64 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb4:	818a0a13          	addi	s4,s4,-2024 # 67c8 <malloc+0xb3e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1006:	7c650513          	addi	a0,a0,1990 # 67c8 <malloc+0xb3e>
  ...
  for(i = 0; i < N; i++){
    ...
    1076:	75e50513          	addi	a0,a0,1886 # 67d0 <malloc+0xb46>
    107a:	00005097          	auipc	ra,0x5
    107e:	b52080e7          	jalr	-1198(ra) # 5bcc <printf>
    exit(1);
    1082:	4505                	li	a0,1
    ...
    1096:	75e50513          	addi	a0,a0,1886 # 67f0 <malloc+0xb66>
    109a:	00005097          	auipc	ra,0x5
    109e:	b32080e7          	jalr	-1230(ra) # 5bcc <printf>
      exit(1);
    10a2:	4505                	li	a0,1
    ...
    10b2:	76250513          	addi	a0,a0,1890 # 6810 <malloc+0xb86>
    10b6:	00005097          	auipc	ra,0x5
    10ba:	b16080e7          	jalr	-1258(ra) # 5bcc <printf>
      exit(1);
    10be:	4505                	li	a0,1
...
00000000000010c8 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e4:	75098993          	addi	s3,s3,1872 # 6830 <malloc+0xba6>
    10e8:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1120:	72450513          	addi	a0,a0,1828 # 6840 <malloc+0xbb6>
    1124:	00005097          	auipc	ra,0x5
    1128:	aa8080e7          	jalr	-1368(ra) # 5bcc <printf>
      exit(1);
    112c:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1148:	4244b483          	ld	s1,1060(s1) # 8568 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117e:	35048493          	addi	s1,s1,848 # c350 <buf+0x5c0>
  for(int i = 0; i < 50000; i++){
    ...
    118c:	f8098993          	addi	s3,s3,-128 # 6108 <malloc+0x47e>
    argv[0] = (char*)0xffffffff;
...
00000000000011b4 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1216:	81678793          	addi	a5,a5,-2026 # 7a28 <malloc+0x1d9e>
  ...
  if(pid == 0){
    ...
    124c:	43078793          	addi	a5,a5,1072 # 8678 <big.1270>
    1250:	00008697          	auipc	a3,0x8
    1254:	42868693          	addi	a3,a3,1064 # 9678 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    126a:	40078923          	sb	zero,1042(a5) # 9678 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126e:	00007797          	auipc	a5,0x7
    1272:	eca78793          	addi	a5,a5,-310 # 8138 <malloc+0x24ae>
    ...
    1296:	e7650513          	addi	a0,a0,-394 # 6108 <malloc+0x47e>
    ...
    12ae:	63e50513          	addi	a0,a0,1598 # 68e8 <malloc+0xc5e>
    12b2:	00005097          	auipc	ra,0x5
    12b6:	91a080e7          	jalr	-1766(ra) # 5bcc <printf>
      exit(1);
    12ba:	4505                	li	a0,1
    ...
    12ce:	59650513          	addi	a0,a0,1430 # 6860 <malloc+0xbd6>
    12d2:	00005097          	auipc	ra,0x5
    12d6:	8fa080e7          	jalr	-1798(ra) # 5bcc <printf>
    exit(1);
    12da:	4505                	li	a0,1
    ...
    12ee:	59650513          	addi	a0,a0,1430 # 6880 <malloc+0xbf6>
    12f2:	00005097          	auipc	ra,0x5
    12f6:	8da080e7          	jalr	-1830(ra) # 5bcc <printf>
    exit(1);
    12fa:	4505                	li	a0,1
    ...
    1310:	59450513          	addi	a0,a0,1428 # 68a0 <malloc+0xc16>
    1314:	00005097          	auipc	ra,0x5
    1318:	8b8080e7          	jalr	-1864(ra) # 5bcc <printf>
    exit(1);
    131c:	4505                	li	a0,1
    ...
    1330:	59c50513          	addi	a0,a0,1436 # 68c8 <malloc+0xc3e>
    1334:	00005097          	auipc	ra,0x5
    1338:	898080e7          	jalr	-1896(ra) # 5bcc <printf>
    exit(1);
    133c:	4505                	li	a0,1
    ...
    134a:	a1a50513          	addi	a0,a0,-1510 # 6d60 <malloc+0x10d6>
    134e:	00005097          	auipc	ra,0x5
    1352:	87e080e7          	jalr	-1922(ra) # 5bcc <printf>
    exit(1);
    1356:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1394:	58050513          	addi	a0,a0,1408 # 6910 <malloc+0xc86>
    1398:	00005097          	auipc	ra,0x5
    139c:	834080e7          	jalr	-1996(ra) # 5bcc <printf>
    exit(1);
    13a0:	4505                	li	a0,1
...
00000000000013aa <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c6:	d9e50513          	addi	a0,a0,-610 # 6160 <malloc+0x4d6>
  ...
  if(pid == 0){
    ...
    13f0:	d74a0a13          	addi	s4,s4,-652 # 6160 <malloc+0x4d6>
      int n = write(fd, "1234567890", 10);
    13f4:	00005a97          	auipc	s5,0x5
    13f8:	57ca8a93          	addi	s5,s5,1404 # 6970 <malloc+0xce6>
      int fd = open("truncfile", O_WRONLY);
    13fc:	4585                	li	a1,1
    13fe:	8552                	mv	a0,s4
    ...
    1468:	4dc50513          	addi	a0,a0,1244 # 6940 <malloc+0xcb6>
    146c:	00004097          	auipc	ra,0x4
    1470:	760080e7          	jalr	1888(ra) # 5bcc <printf>
    exit(1);
    1474:	4505                	li	a0,1
    ...
    1484:	4d850513          	addi	a0,a0,1240 # 6958 <malloc+0xcce>
    1488:	00004097          	auipc	ra,0x4
    148c:	744080e7          	jalr	1860(ra) # 5bcc <printf>
        exit(1);
    1490:	4505                	li	a0,1
    ...
    14a2:	4e250513          	addi	a0,a0,1250 # 6980 <malloc+0xcf6>
    14a6:	00004097          	auipc	ra,0x4
    14aa:	726080e7          	jalr	1830(ra) # 5bcc <printf>
        exit(1);
    14ae:	4505                	li	a0,1
    ...
    14c0:	ca4a0a13          	addi	s4,s4,-860 # 6160 <malloc+0x4d6>
    int n = write(fd, "xxx", 3);
    14c4:	00005a97          	auipc	s5,0x5
    14c8:	4dca8a93          	addi	s5,s5,1244 # 69a0 <malloc+0xd16>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1512:	c5250513          	addi	a0,a0,-942 # 6160 <malloc+0x4d6>
  ...
  exit(xstatus);
    ...
    1530:	42c50513          	addi	a0,a0,1068 # 6958 <malloc+0xcce>
    1534:	00004097          	auipc	ra,0x4
    1538:	698080e7          	jalr	1688(ra) # 5bcc <printf>
      exit(1);
    153c:	4505                	li	a0,1
    ...
    154e:	45e50513          	addi	a0,a0,1118 # 69a8 <malloc+0xd1e>
    1552:	00004097          	auipc	ra,0x4
    1556:	67a080e7          	jalr	1658(ra) # 5bcc <printf>
      exit(1);
    155a:	4505                	li	a0,1
...
0000000000001564 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1576:	b9678793          	addi	a5,a5,-1130 # 6108 <malloc+0x47e>
    157a:	fcf43023          	sd	a5,-64(s0)
    157e:	00005797          	auipc	a5,0x5
    1582:	44a78793          	addi	a5,a5,1098 # 69c8 <malloc+0xd3e>
    1586:	fcf43423          	sd	a5,-56(s0)
    158a:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158e:	00005517          	auipc	a0,0x5
    1592:	44250513          	addi	a0,a0,1090 # 69d0 <malloc+0xd46>
  ...
  if(pid == 0) {
    ...
    15c0:	41450513          	addi	a0,a0,1044 # 69d0 <malloc+0xd46>
    ...
    15dc:	41850513          	addi	a0,a0,1048 # 69f0 <malloc+0xd66>
    15e0:	00004097          	auipc	ra,0x4
    15e4:	5ec080e7          	jalr	1516(ra) # 5bcc <printf>
      exit(1);
    15e8:	4505                	li	a0,1
    ...
    15f8:	34c50513          	addi	a0,a0,844 # 6940 <malloc+0xcb6>
    15fc:	00004097          	auipc	ra,0x4
    1600:	5d0080e7          	jalr	1488(ra) # 5bcc <printf>
     exit(1);
    1604:	4505                	li	a0,1
    ...
    1614:	3c850513          	addi	a0,a0,968 # 69d8 <malloc+0xd4e>
    1618:	00004097          	auipc	ra,0x4
    161c:	5b4080e7          	jalr	1460(ra) # 5bcc <printf>
      exit(1);
    1620:	4505                	li	a0,1
    ...
    1632:	ada50513          	addi	a0,a0,-1318 # 6108 <malloc+0x47e>
  ...
  if(xstatus != 0)
    ...
    1666:	39e50513          	addi	a0,a0,926 # 6a00 <malloc+0xd76>
    166a:	00004097          	auipc	ra,0x4
    166e:	562080e7          	jalr	1378(ra) # 5bcc <printf>
      exit(1);
    1672:	4505                	li	a0,1
    ...
    1682:	39a50513          	addi	a0,a0,922 # 6a18 <malloc+0xd8e>
    1686:	00004097          	auipc	ra,0x4
    168a:	546080e7          	jalr	1350(ra) # 5bcc <printf>
    168e:	b7d1                	j	1652 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    1690:	4581                	li	a1,0
    1692:	00005517          	auipc	a0,0x5
    1696:	33e50513          	addi	a0,a0,830 # 69d0 <malloc+0xd46>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16c0:	ddc50513          	addi	a0,a0,-548 # 6498 <malloc+0x80e>
    16c4:	00004097          	auipc	ra,0x4
    16c8:	508080e7          	jalr	1288(ra) # 5bcc <printf>
    exit(1);
    16cc:	4505                	li	a0,1
    ...
    16dc:	28050513          	addi	a0,a0,640 # 6958 <malloc+0xcce>
    16e0:	00004097          	auipc	ra,0x4
    16e4:	4ec080e7          	jalr	1260(ra) # 5bcc <printf>
    exit(1);
    16e8:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f6:	2de50513          	addi	a0,a0,734 # 69d0 <malloc+0xd46>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1720:	31450513          	addi	a0,a0,788 # 6a30 <malloc+0xda6>
    1724:	00004097          	auipc	ra,0x4
    1728:	4a8080e7          	jalr	1192(ra) # 5bcc <printf>
    exit(1);
    172c:	4505                	li	a0,1
...
0000000000001740 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178c:	608a8a93          	addi	s5,s5,1544 # bd90 <buf>
      if(cc > sizeof(buf))
    ...
    17aa:	5ea70713          	addi	a4,a4,1514 # bd90 <buf>
    ...
    17e2:	26a50513          	addi	a0,a0,618 # 6a48 <malloc+0xdbe>
    17e6:	00004097          	auipc	ra,0x4
    17ea:	3e6080e7          	jalr	998(ra) # 5bcc <printf>
    exit(1);
    17ee:	4505                	li	a0,1
    ...
    1808:	58cb0b13          	addi	s6,s6,1420 # bd90 <buf>
    ...
    181c:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x83>
{
    ...
    1868:	1fc50513          	addi	a0,a0,508 # 6a60 <malloc+0xdd6>
    186c:	00004097          	auipc	ra,0x4
    1870:	360080e7          	jalr	864(ra) # 5bcc <printf>
        exit(1);
    1874:	4505                	li	a0,1
    ...
    1884:	1f850513          	addi	a0,a0,504 # 6a78 <malloc+0xdee>
    1888:	00004097          	auipc	ra,0x4
    188c:	344080e7          	jalr	836(ra) # 5bcc <printf>
}
    ...
    18b6:	1de50513          	addi	a0,a0,478 # 6a90 <malloc+0xe06>
    18ba:	00004097          	auipc	ra,0x4
    18be:	312080e7          	jalr	786(ra) # 5bcc <printf>
      exit(1);
    18c2:	4505                	li	a0,1
    ...
    18f6:	1be50513          	addi	a0,a0,446 # 6ab0 <malloc+0xe26>
    18fa:	00004097          	auipc	ra,0x4
    18fe:	2d2080e7          	jalr	722(ra) # 5bcc <printf>
    exit(1);
    1902:	4505                	li	a0,1
...
000000000000190c <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1968:	fdc50513          	addi	a0,a0,-36 # 6940 <malloc+0xcb6>
    196c:	00004097          	auipc	ra,0x4
    1970:	260080e7          	jalr	608(ra) # 5bcc <printf>
      exit(1);
    1974:	4505                	li	a0,1
    ...
    1984:	14850513          	addi	a0,a0,328 # 6ac8 <malloc+0xe3e>
    1988:	00004097          	auipc	ra,0x4
    198c:	244080e7          	jalr	580(ra) # 5bcc <printf>
        exit(1);
    1990:	4505                	li	a0,1
    ...
    19a0:	14450513          	addi	a0,a0,324 # 6ae0 <malloc+0xe56>
    19a4:	00004097          	auipc	ra,0x4
    19a8:	228080e7          	jalr	552(ra) # 5bcc <printf>
        exit(1);
    19ac:	4505                	li	a0,1
...
00000000000019c0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a18:	f2c50513          	addi	a0,a0,-212 # 6940 <malloc+0xcb6>
    1a1c:	00004097          	auipc	ra,0x4
    1a20:	1b0080e7          	jalr	432(ra) # 5bcc <printf>
      exit(1);
    1a24:	4505                	li	a0,1
    ...
    1a3c:	f0850513          	addi	a0,a0,-248 # 6940 <malloc+0xcb6>
    1a40:	00004097          	auipc	ra,0x4
    1a44:	18c080e7          	jalr	396(ra) # 5bcc <printf>
        exit(1);
    1a48:	4505                	li	a0,1
...
0000000000001a5a <forkfork>:
{
    ...
    1ab6:	04e50513          	addi	a0,a0,78 # 6b00 <malloc+0xe76>
    1aba:	00004097          	auipc	ra,0x4
    1abe:	112080e7          	jalr	274(ra) # 5bcc <printf>
      exit(1);
    1ac2:	4505                	li	a0,1
    ...
    1ac8:	d90080e7          	jalr	-624(ra) # 5854 <exit>
{
    ...
    1b0e:	00650513          	addi	a0,a0,6 # 6b10 <malloc+0xe86>
    1b12:	00004097          	auipc	ra,0x4
    1b16:	0ba080e7          	jalr	186(ra) # 5bcc <printf>
      exit(1);
    1b1a:	4505                	li	a0,1
...
0000000000001b24 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5c:	20850513          	addi	a0,a0,520 # 6d60 <malloc+0x10d6>
    1b60:	00004097          	auipc	ra,0x4
    1b64:	06c080e7          	jalr	108(ra) # 5bcc <printf>
      exit(1);
    1b68:	4505                	li	a0,1
...
0000000000001b8c <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bfa:	16a50513          	addi	a0,a0,362 # 6d60 <malloc+0x10d6>
    1bfe:	00004097          	auipc	ra,0x4
    1c02:	fce080e7          	jalr	-50(ra) # 5bcc <printf>
      exit(1);
    1c06:	4505                	li	a0,1
    ...
    1c26:	db650513          	addi	a0,a0,-586 # 69d8 <malloc+0xd4e>
    1c2a:	00004097          	auipc	ra,0x4
    1c2e:	fa2080e7          	jalr	-94(ra) # 5bcc <printf>
          exit(1);
    1c32:	4505                	li	a0,1
    ...
    1c98:	e9c50513          	addi	a0,a0,-356 # 6b30 <malloc+0xea6>
    1c9c:	00004097          	auipc	ra,0x4
    1ca0:	f30080e7          	jalr	-208(ra) # 5bcc <printf>
            exit(1);
    1ca4:	4505                	li	a0,1
    ...
    1ccc:	e8050513          	addi	a0,a0,-384 # 6b48 <malloc+0xebe>
    1cd0:	00004097          	auipc	ra,0x4
    1cd4:	efc080e7          	jalr	-260(ra) # 5bcc <printf>
        exit(1);
    1cd8:	4505                	li	a0,1
    ...
    1d32:	e4250513          	addi	a0,a0,-446 # 6b70 <malloc+0xee6>
    1d36:	00004097          	auipc	ra,0x4
    1d3a:	e96080e7          	jalr	-362(ra) # 5bcc <printf>
        exit(1);
    1d3e:	4505                	li	a0,1
...
0000000000001db2 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd2:	3aa50513          	addi	a0,a0,938 # 6178 <malloc+0x4ee>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0e:	36ea8a93          	addi	s5,s5,878 # 6178 <malloc+0x4ee>
      link("cat", "x");
    1e12:	00005b97          	auipc	s7,0x5
    1e16:	d86b8b93          	addi	s7,s7,-634 # 6b98 <malloc+0xf0e>
    1e1a:	a091                	j	1e5e <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1c:	85a6                	mv	a1,s1
    1e1e:	00005517          	auipc	a0,0x5
    1e22:	b2250513          	addi	a0,a0,-1246 # 6940 <malloc+0xcb6>
    1e26:	00004097          	auipc	ra,0x4
    1e2a:	da6080e7          	jalr	-602(ra) # 5bcc <printf>
    exit(1);
    1e2e:	4505                	li	a0,1
...
0000000000001eb4 <manywrites>:
{
  ...
  exit(0);
    ...
    1f10:	e5450513          	addi	a0,a0,-428 # 6d60 <malloc+0x10d6>
    1f14:	00004097          	auipc	ra,0x4
    1f18:	cb8080e7          	jalr	-840(ra) # 5bcc <printf>
      exit(1);
    1f1c:	4505                	li	a0,1
    ...
    1f4c:	e48b8b93          	addi	s7,s7,-440 # bd90 <buf>
    ...
    1fc0:	be450513          	addi	a0,a0,-1052 # 6ba0 <malloc+0xf16>
    1fc4:	00004097          	auipc	ra,0x4
    1fc8:	c08080e7          	jalr	-1016(ra) # 5bcc <printf>
            exit(1);
    1fcc:	4505                	li	a0,1
    ...
    1fe0:	1ec50513          	addi	a0,a0,492 # 61c8 <malloc+0x53e>
    1fe4:	00004097          	auipc	ra,0x4
    1fe8:	be8080e7          	jalr	-1048(ra) # 5bcc <printf>
            exit(1);
    1fec:	4505                	li	a0,1
...
0000000000001ffe <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202e:	ba650513          	addi	a0,a0,-1114 # 6bd0 <malloc+0xf46>
    2032:	00004097          	auipc	ra,0x4
    2036:	b9a080e7          	jalr	-1126(ra) # 5bcc <printf>
    exit(1);
    203a:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2090:	b2c50513          	addi	a0,a0,-1236 # 6bb8 <malloc+0xf2e>
    2094:	00004097          	auipc	ra,0x4
    2098:	b38080e7          	jalr	-1224(ra) # 5bcc <printf>
    exit(1);
    209c:	4505                	li	a0,1
    ...
    20ac:	b5050513          	addi	a0,a0,-1200 # 6bf8 <malloc+0xf6e>
    20b0:	00004097          	auipc	ra,0x4
    20b4:	b1c080e7          	jalr	-1252(ra) # 5bcc <printf>
      exit(1);
    20b8:	4505                	li	a0,1
    ...
    20c8:	b4c50513          	addi	a0,a0,-1204 # 6c10 <malloc+0xf86>
    20cc:	00004097          	auipc	ra,0x4
    20d0:	b00080e7          	jalr	-1280(ra) # 5bcc <printf>
    exit(1);
    20d4:	4505                	li	a0,1
...
00000000000020de <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20fa:	35098993          	addi	s3,s3,848 # c350 <buf+0x5c0>
    20fe:	1003d937          	lui	s2,0x1003d
    2102:	090e                	slli	s2,s2,0x3
    2104:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e6e0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2148:	7fc50513          	addi	a0,a0,2044 # 6940 <malloc+0xcb6>
    214c:	00004097          	auipc	ra,0x4
    2150:	a80080e7          	jalr	-1408(ra) # 5bcc <printf>
      exit(1);
    2154:	4505                	li	a0,1
    ...
    216a:	ac250513          	addi	a0,a0,-1342 # 6c28 <malloc+0xf9e>
    216e:	00004097          	auipc	ra,0x4
    2172:	a5e080e7          	jalr	-1442(ra) # 5bcc <printf>
      exit(1);
    2176:	4505                	li	a0,1
...
000000000000218a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ec:	75850513          	addi	a0,a0,1880 # 6940 <malloc+0xcb6>
    21f0:	00004097          	auipc	ra,0x4
    21f4:	9dc080e7          	jalr	-1572(ra) # 5bcc <printf>
      exit(1);
    21f8:	4505                	li	a0,1
    ...
    2218:	a3450513          	addi	a0,a0,-1484 # 6c48 <malloc+0xfbe>
    221c:	00004097          	auipc	ra,0x4
    2220:	9b0080e7          	jalr	-1616(ra) # 5bcc <printf>
      exit(1);
    2224:	4505                	li	a0,1
...
0000000000002238 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2248:	a1c50513          	addi	a0,a0,-1508 # 6c60 <malloc+0xfd6>
  ...
  fd = open("bigarg-ok", 0);
    ...
    227a:	9ea50513          	addi	a0,a0,-1558 # 6c60 <malloc+0xfd6>
  ...
  close(fd);
    ...
    22a0:	2dc78793          	addi	a5,a5,732 # 8578 <args.1859>
    22a4:	00006697          	auipc	a3,0x6
    22a8:	3cc68693          	addi	a3,a3,972 # 8670 <args.1859+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22ac:	00005717          	auipc	a4,0x5
    22b0:	9c470713          	addi	a4,a4,-1596 # 6c70 <malloc+0xfe6>
    ...
    2304:	a5050513          	addi	a0,a0,-1456 # 6d50 <malloc+0x10c6>
    2308:	00004097          	auipc	ra,0x4
    230c:	8c4080e7          	jalr	-1852(ra) # 5bcc <printf>
    exit(1);
    2310:	4505                	li	a0,1
    ...
    2328:	a4c50513          	addi	a0,a0,-1460 # 6d70 <malloc+0x10e6>
    232c:	00004097          	auipc	ra,0x4
    2330:	8a0080e7          	jalr	-1888(ra) # 5bcc <printf>
    exit(1);
    2334:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237c:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0260>
    2380:	85a6                	mv	a1,s1
    2382:	00005517          	auipc	a0,0x5
    2386:	a0e50513          	addi	a0,a0,-1522 # 6d90 <malloc+0x1106>
    238a:	00004097          	auipc	ra,0x4
    238e:	842080e7          	jalr	-1982(ra) # 5bcc <printf>
    exit(1);
    2392:	4505                	li	a0,1
    ...
    23a2:	5a250513          	addi	a0,a0,1442 # 6940 <malloc+0xcb6>
    23a6:	00004097          	auipc	ra,0x4
    23aa:	826080e7          	jalr	-2010(ra) # 5bcc <printf>
    exit(1);
    23ae:	4505                	li	a0,1
...
00000000000023c2 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243c:	5f078793          	addi	a5,a5,1520 # 7a28 <malloc+0x1d9e>
  ...
  if(ret != -1){
    ...
    247e:	93e50513          	addi	a0,a0,-1730 # 6db8 <malloc+0x112e>
    2482:	00003097          	auipc	ra,0x3
    2486:	74a080e7          	jalr	1866(ra) # 5bcc <printf>
    exit(1);
    248a:	4505                	li	a0,1
    ...
    249c:	3c850513          	addi	a0,a0,968 # 6860 <malloc+0xbd6>
    24a0:	00003097          	auipc	ra,0x3
    24a4:	72c080e7          	jalr	1836(ra) # 5bcc <printf>
    exit(1);
    24a8:	4505                	li	a0,1
    ...
    24ba:	3ca50513          	addi	a0,a0,970 # 6880 <malloc+0xbf6>
    24be:	00003097          	auipc	ra,0x3
    24c2:	70e080e7          	jalr	1806(ra) # 5bcc <printf>
    exit(1);
    24c6:	4505                	li	a0,1
    ...
    24da:	3ca50513          	addi	a0,a0,970 # 68a0 <malloc+0xc16>
    24de:	00003097          	auipc	ra,0x3
    24e2:	6ee080e7          	jalr	1774(ra) # 5bcc <printf>
    exit(1);
    24e6:	4505                	li	a0,1
    ...
    24f8:	3d450513          	addi	a0,a0,980 # 68c8 <malloc+0xc3e>
    24fc:	00003097          	auipc	ra,0x3
    2500:	6d0080e7          	jalr	1744(ra) # 5bcc <printf>
    exit(1);
    2504:	4505                	li	a0,1
...
000000000000250e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2544:	8b850513          	addi	a0,a0,-1864 # 5df8 <malloc+0x16e>
  ...
  if(n >= 0){
    ...
    2576:	89e50513          	addi	a0,a0,-1890 # 6e10 <malloc+0x1186>
    257a:	00003097          	auipc	ra,0x3
    257e:	652080e7          	jalr	1618(ra) # 5bcc <printf>
    exit(1);
    2582:	4505                	li	a0,1
    ...
    2590:	83450513          	addi	a0,a0,-1996 # 6dc0 <malloc+0x1136>
    2594:	00003097          	auipc	ra,0x3
    2598:	638080e7          	jalr	1592(ra) # 5bcc <printf>
    exit(1);
    259c:	4505                	li	a0,1
    ...
    25aa:	83250513          	addi	a0,a0,-1998 # 6dd8 <malloc+0x114e>
    25ae:	00003097          	auipc	ra,0x3
    25b2:	61e080e7          	jalr	1566(ra) # 5bcc <printf>
    exit(1);
    25b6:	4505                	li	a0,1
    ...
    25c4:	83850513          	addi	a0,a0,-1992 # 6df8 <malloc+0x116e>
    25c8:	00003097          	auipc	ra,0x3
    25cc:	604080e7          	jalr	1540(ra) # 5bcc <printf>
    exit(1);
    25d0:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e8:	81450513          	addi	a0,a0,-2028 # 5df8 <malloc+0x16e>
    25ec:	00003097          	auipc	ra,0x3
    25f0:	2b8080e7          	jalr	696(ra) # 58a4 <unlink>
  fd = open("README", O_RDONLY);
    25f4:	4581                	li	a1,0
    25f6:	00004517          	auipc	a0,0x4
    25fa:	caa50513          	addi	a0,a0,-854 # 62a0 <malloc+0x616>
  ...
  if(n >= 0){
    ...
    2624:	82050513          	addi	a0,a0,-2016 # 6e40 <malloc+0x11b6>
    2628:	00003097          	auipc	ra,0x3
    262c:	5a4080e7          	jalr	1444(ra) # 5bcc <printf>
    exit(1);
    2630:	4505                	li	a0,1
    ...
    263e:	7be50513          	addi	a0,a0,1982 # 6df8 <malloc+0x116e>
    2642:	00003097          	auipc	ra,0x3
    2646:	58a080e7          	jalr	1418(ra) # 5bcc <printf>
    exit(1);
    264a:	4505                	li	a0,1
...
0000000000002668 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a6:	6705                	lui	a4,0x1
      *b = 99;
    26a8:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1260>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26c0:	7ac50513          	addi	a0,a0,1964 # 6e68 <malloc+0x11de>
    26c4:	00003097          	auipc	ra,0x3
    26c8:	508080e7          	jalr	1288(ra) # 5bcc <printf>
    exit(1);
    26cc:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2714:	77850513          	addi	a0,a0,1912 # 6e88 <malloc+0x11fe>
    2718:	00003097          	auipc	ra,0x3
    271c:	4b4080e7          	jalr	1204(ra) # 5bcc <printf>
    exit(1);
    2720:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2776:	77650513          	addi	a0,a0,1910 # 6ee8 <malloc+0x125e>
    277a:	00003097          	auipc	ra,0x3
    277e:	452080e7          	jalr	1106(ra) # 5bcc <printf>
    exit(1);
    2782:	4505                	li	a0,1
    ...
    2798:	71450513          	addi	a0,a0,1812 # 6ea8 <malloc+0x121e>
    279c:	00003097          	auipc	ra,0x3
    27a0:	430080e7          	jalr	1072(ra) # 5bcc <printf>
      exit(1);
    27a4:	4505                	li	a0,1
    ...
    27b4:	71850513          	addi	a0,a0,1816 # 6ec8 <malloc+0x123e>
    27b8:	00003097          	auipc	ra,0x3
    27bc:	414080e7          	jalr	1044(ra) # 5bcc <printf>
    exit(1);
    27c0:	4505                	li	a0,1
...
00000000000027f0 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2852:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f125f>
  a = sbrk(0);
    2856:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b6:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f125f>
  ...
  if(c != a){
    ...
    28fe:	60e50513          	addi	a0,a0,1550 # 6f08 <malloc+0x127e>
    2902:	00003097          	auipc	ra,0x3
    2906:	2ca080e7          	jalr	714(ra) # 5bcc <printf>
    exit(1);
    290a:	4505                	li	a0,1
    ...
    291a:	63a50513          	addi	a0,a0,1594 # 6f50 <malloc+0x12c6>
    291e:	00003097          	auipc	ra,0x3
    2922:	2ae080e7          	jalr	686(ra) # 5bcc <printf>
    exit(1);
    2926:	4505                	li	a0,1
    ...
    293a:	63a50513          	addi	a0,a0,1594 # 6f70 <malloc+0x12e6>
    293e:	00003097          	auipc	ra,0x3
    2942:	28e080e7          	jalr	654(ra) # 5bcc <printf>
    exit(1);
    2946:	4505                	li	a0,1
    ...
    295a:	65a50513          	addi	a0,a0,1626 # 6fb0 <malloc+0x1326>
    295e:	00003097          	auipc	ra,0x3
    2962:	26e080e7          	jalr	622(ra) # 5bcc <printf>
    exit(1);
    2966:	4505                	li	a0,1
    ...
    2976:	66e50513          	addi	a0,a0,1646 # 6fe0 <malloc+0x1356>
    297a:	00003097          	auipc	ra,0x3
    297e:	252080e7          	jalr	594(ra) # 5bcc <printf>
    exit(1);
    2982:	4505                	li	a0,1
    ...
    2996:	68650513          	addi	a0,a0,1670 # 7018 <malloc+0x138e>
    299a:	00003097          	auipc	ra,0x3
    299e:	232080e7          	jalr	562(ra) # 5bcc <printf>
    exit(1);
    29a2:	4505                	li	a0,1
...
00000000000029ac <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29d0:	67450513          	addi	a0,a0,1652 # 7040 <malloc+0x13b6>
    29d4:	00003097          	auipc	ra,0x3
    29d8:	ec0080e7          	jalr	-320(ra) # 5894 <open>
    29dc:	84aa                	mv	s1,a0
  unlink("sbrk");
    29de:	00004517          	auipc	a0,0x4
    29e2:	66250513          	addi	a0,a0,1634 # 7040 <malloc+0x13b6>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a36:	61650513          	addi	a0,a0,1558 # 7048 <malloc+0x13be>
    2a3a:	00003097          	auipc	ra,0x3
    2a3e:	192080e7          	jalr	402(ra) # 5bcc <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a52:	61250513          	addi	a0,a0,1554 # 7060 <malloc+0x13d6>
    2a56:	00003097          	auipc	ra,0x3
    2a5a:	176080e7          	jalr	374(ra) # 5bcc <printf>
    exit(1);
    2a5e:	4505                	li	a0,1
    ...
    2a6e:	fde50513          	addi	a0,a0,-34 # 6a48 <malloc+0xdbe>
    2a72:	00003097          	auipc	ra,0x3
    2a76:	15a080e7          	jalr	346(ra) # 5bcc <printf>
    exit(1);
    2a7a:	4505                	li	a0,1
...
0000000000002a84 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a98:	5e450513          	addi	a0,a0,1508 # 7078 <malloc+0x13ee>
  ...
  close(fd);
    ...
    2ae0:	e7c50513          	addi	a0,a0,-388 # 6958 <malloc+0xcce>
    2ae4:	00003097          	auipc	ra,0x3
    2ae8:	0e8080e7          	jalr	232(ra) # 5bcc <printf>
    exit(1);
    2aec:	4505                	li	a0,1
...
0000000000002af6 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2e:	23650513          	addi	a0,a0,566 # 6d60 <malloc+0x10d6>
    2b32:	00003097          	auipc	ra,0x3
    2b36:	09a080e7          	jalr	154(ra) # 5bcc <printf>
    exit(1);
    2b3a:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b84:	1e050513          	addi	a0,a0,480 # 6d60 <malloc+0x10d6>
    2b88:	00003097          	auipc	ra,0x3
    2b8c:	044080e7          	jalr	68(ra) # 5bcc <printf>
    exit(1);
    2b90:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be4:	18050513          	addi	a0,a0,384 # 6d60 <malloc+0x10d6>
    2be8:	00003097          	auipc	ra,0x3
    2bec:	fe4080e7          	jalr	-28(ra) # 5bcc <printf>
    exit(1);
    2bf0:	4505                	li	a0,1
...
0000000000002ce0 <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2d00:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff125f>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d58:	00c50513          	addi	a0,a0,12 # 6d60 <malloc+0x10d6>
    2d5c:	00003097          	auipc	ra,0x3
    2d60:	e70080e7          	jalr	-400(ra) # 5bcc <printf>
      exit(1);
    2d64:	4505                	li	a0,1
    ...
    2dac:	36050513          	addi	a0,a0,864 # 6108 <malloc+0x47e>
    2db0:	faa43c23          	sd	a0,-72(s0)
    2db4:	00003797          	auipc	a5,0x3
    2db8:	3c478793          	addi	a5,a5,964 # 6178 <malloc+0x4ee>
...
0000000000002dda <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2dea:	46a50513          	addi	a0,a0,1130 # 7250 <malloc+0x15c6>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfc:	2b050513          	addi	a0,a0,688 # 70a8 <malloc+0x141e>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e12:	2f250513          	addi	a0,a0,754 # 7100 <malloc+0x1476>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e30:	34c50513          	addi	a0,a0,844 # 7178 <malloc+0x14ee>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4c:	3a050513          	addi	a0,a0,928 # 71e8 <malloc+0x155e>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5e:	3e650513          	addi	a0,a0,998 # 7240 <malloc+0x15b6>
  ...
  unlink("12345678901234");
    ...
    2edc:	1a850513          	addi	a0,a0,424 # 7080 <malloc+0x13f6>
    2ee0:	00003097          	auipc	ra,0x3
    2ee4:	cec080e7          	jalr	-788(ra) # 5bcc <printf>
    exit(1);
    2ee8:	4505                	li	a0,1
    ...
    2ef8:	1d450513          	addi	a0,a0,468 # 70c8 <malloc+0x143e>
    2efc:	00003097          	auipc	ra,0x3
    2f00:	cd0080e7          	jalr	-816(ra) # 5bcc <printf>
    exit(1);
    2f04:	4505                	li	a0,1
    ...
    2f14:	22050513          	addi	a0,a0,544 # 7130 <malloc+0x14a6>
    2f18:	00003097          	auipc	ra,0x3
    2f1c:	cb4080e7          	jalr	-844(ra) # 5bcc <printf>
    exit(1);
    2f20:	4505                	li	a0,1
    ...
    2f30:	27c50513          	addi	a0,a0,636 # 71a8 <malloc+0x151e>
    2f34:	00003097          	auipc	ra,0x3
    2f38:	c98080e7          	jalr	-872(ra) # 5bcc <printf>
    exit(1);
    2f3c:	4505                	li	a0,1
    ...
    2f4c:	2c050513          	addi	a0,a0,704 # 7208 <malloc+0x157e>
    2f50:	00003097          	auipc	ra,0x3
    2f54:	c7c080e7          	jalr	-900(ra) # 5bcc <printf>
    exit(1);
    2f58:	4505                	li	a0,1
    ...
    2f68:	2fc50513          	addi	a0,a0,764 # 7260 <malloc+0x15d6>
    2f6c:	00003097          	auipc	ra,0x3
    2f70:	c60080e7          	jalr	-928(ra) # 5bcc <printf>
    exit(1);
    2f74:	4505                	li	a0,1
...
0000000000002f7e <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8e:	30e50513          	addi	a0,a0,782 # 7298 <malloc+0x160e>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa2:	2fa50513          	addi	a0,a0,762 # 7298 <malloc+0x160e>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb6:	32650513          	addi	a0,a0,806 # 72d8 <malloc+0x164e>
  ...
  if(chdir("/") < 0){
    ...
    2fca:	34250513          	addi	a0,a0,834 # 7308 <malloc+0x167e>
    ...
    2fea:	2ba50513          	addi	a0,a0,698 # 72a0 <malloc+0x1616>
    2fee:	00003097          	auipc	ra,0x3
    2ff2:	bde080e7          	jalr	-1058(ra) # 5bcc <printf>
    exit(1);
    2ff6:	4505                	li	a0,1
    ...
    3006:	2b650513          	addi	a0,a0,694 # 72b8 <malloc+0x162e>
    300a:	00003097          	auipc	ra,0x3
    300e:	bc2080e7          	jalr	-1086(ra) # 5bcc <printf>
    exit(1);
    3012:	4505                	li	a0,1
    ...
    3022:	2ca50513          	addi	a0,a0,714 # 72e8 <malloc+0x165e>
    3026:	00003097          	auipc	ra,0x3
    302a:	ba6080e7          	jalr	-1114(ra) # 5bcc <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303e:	2d650513          	addi	a0,a0,726 # 7310 <malloc+0x1686>
    3042:	00003097          	auipc	ra,0x3
    3046:	b8a080e7          	jalr	-1142(ra) # 5bcc <printf>
    exit(1);
    304a:	4505                	li	a0,1
...
0000000000003054 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3072:	22a50513          	addi	a0,a0,554 # 7298 <malloc+0x160e>
    ...
    3086:	21650513          	addi	a0,a0,534 # 7298 <malloc+0x160e>
    ...
    309a:	24250513          	addi	a0,a0,578 # 72d8 <malloc+0x164e>
    ...
    30ba:	88a50513          	addi	a0,a0,-1910 # 6940 <malloc+0xcb6>
    30be:	00003097          	auipc	ra,0x3
    30c2:	b0e080e7          	jalr	-1266(ra) # 5bcc <printf>
    exit(1);
    30c6:	4505                	li	a0,1
    ...
    30d6:	1ce50513          	addi	a0,a0,462 # 72a0 <malloc+0x1616>
    30da:	00003097          	auipc	ra,0x3
    30de:	af2080e7          	jalr	-1294(ra) # 5bcc <printf>
      exit(1);
    30e2:	4505                	li	a0,1
    ...
    30f2:	23a50513          	addi	a0,a0,570 # 7328 <malloc+0x169e>
    30f6:	00003097          	auipc	ra,0x3
    30fa:	ad6080e7          	jalr	-1322(ra) # 5bcc <printf>
      exit(1);
    30fe:	4505                	li	a0,1
    ...
    310e:	1de50513          	addi	a0,a0,478 # 72e8 <malloc+0x165e>
    3112:	00003097          	auipc	ra,0x3
    3116:	aba080e7          	jalr	-1350(ra) # 5bcc <printf>
      exit(1);
    311a:	4505                	li	a0,1
...
000000000000313c <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314c:	1f850513          	addi	a0,a0,504 # 7340 <malloc+0x16b6>
  ...
  if(chdir("dir0") < 0){
    ...
    3160:	1e450513          	addi	a0,a0,484 # 7340 <malloc+0x16b6>
  ...
  if(chdir("..") < 0){
    ...
    3174:	1f050513          	addi	a0,a0,496 # 7360 <malloc+0x16d6>
  ...
  if(unlink("dir0") < 0){
    ...
    3188:	1bc50513          	addi	a0,a0,444 # 7340 <malloc+0x16b6>
    ...
    31a8:	0fc50513          	addi	a0,a0,252 # 72a0 <malloc+0x1616>
    31ac:	00003097          	auipc	ra,0x3
    31b0:	a20080e7          	jalr	-1504(ra) # 5bcc <printf>
    exit(1);
    31b4:	4505                	li	a0,1
    ...
    31c4:	18850513          	addi	a0,a0,392 # 7348 <malloc+0x16be>
    31c8:	00003097          	auipc	ra,0x3
    31cc:	a04080e7          	jalr	-1532(ra) # 5bcc <printf>
    exit(1);
    31d0:	4505                	li	a0,1
    ...
    31e0:	18c50513          	addi	a0,a0,396 # 7368 <malloc+0x16de>
    31e4:	00003097          	auipc	ra,0x3
    31e8:	9e8080e7          	jalr	-1560(ra) # 5bcc <printf>
    exit(1);
    31ec:	4505                	li	a0,1
    ...
    31fc:	18850513          	addi	a0,a0,392 # 7380 <malloc+0x16f6>
    3200:	00003097          	auipc	ra,0x3
    3204:	9cc080e7          	jalr	-1588(ra) # 5bcc <printf>
    exit(1);
    3208:	4505                	li	a0,1
...
0000000000003212 <subdir>:
{
  ...
  unlink("ff");
    ...
    3224:	2a850513          	addi	a0,a0,680 # 74c8 <malloc+0x183e>
    3228:	00002097          	auipc	ra,0x2
    322c:	67c080e7          	jalr	1660(ra) # 58a4 <unlink>
  if(mkdir("dd") != 0){
    3230:	00004517          	auipc	a0,0x4
    3234:	16850513          	addi	a0,a0,360 # 7398 <malloc+0x170e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324c:	17050513          	addi	a0,a0,368 # 73b8 <malloc+0x172e>
  ...
  write(fd, "ff", 2);
    ...
    3264:	26858593          	addi	a1,a1,616 # 74c8 <malloc+0x183e>
  ...
  if(unlink("dd") >= 0){
    ...
    327e:	11e50513          	addi	a0,a0,286 # 7398 <malloc+0x170e>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3292:	18250513          	addi	a0,a0,386 # 7410 <malloc+0x1786>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32aa:	19250513          	addi	a0,a0,402 # 7438 <malloc+0x17ae>
  ...
  write(fd, "FF", 2);
    ...
    32c2:	1aa58593          	addi	a1,a1,426 # 7468 <malloc+0x17de>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32de:	19650513          	addi	a0,a0,406 # 7470 <malloc+0x17e6>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f6:	a9e58593          	addi	a1,a1,-1378 # bd90 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330c:	a8874703          	lbu	a4,-1400(a4) # bd90 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3326:	19e58593          	addi	a1,a1,414 # 74c0 <malloc+0x1836>
    332a:	00004517          	auipc	a0,0x4
    332e:	10e50513          	addi	a0,a0,270 # 7438 <malloc+0x17ae>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3342:	0fa50513          	addi	a0,a0,250 # 7438 <malloc+0x17ae>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3358:	0e450513          	addi	a0,a0,228 # 7438 <malloc+0x17ae>
  ...
  if(chdir("dd") != 0){
    ...
    336c:	03050513          	addi	a0,a0,48 # 7398 <malloc+0x170e>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3380:	1dc50513          	addi	a0,a0,476 # 7558 <malloc+0x18ce>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3394:	1f850513          	addi	a0,a0,504 # 7588 <malloc+0x18fe>
  ...
  if(chdir("./..") != 0){
    ...
    33a8:	21450513          	addi	a0,a0,532 # 75b8 <malloc+0x192e>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33be:	10650513          	addi	a0,a0,262 # 74c0 <malloc+0x1836>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d6:	9be58593          	addi	a1,a1,-1602 # bd90 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f8:	04450513          	addi	a0,a0,68 # 7438 <malloc+0x17ae>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3410:	23c50513          	addi	a0,a0,572 # 7648 <malloc+0x19be>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3428:	25450513          	addi	a0,a0,596 # 7678 <malloc+0x19ee>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3440:	f5c50513          	addi	a0,a0,-164 # 7398 <malloc+0x170e>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3456:	f4650513          	addi	a0,a0,-186 # 7398 <malloc+0x170e>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346c:	f3050513          	addi	a0,a0,-208 # 7398 <malloc+0x170e>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3480:	28c58593          	addi	a1,a1,652 # 7708 <malloc+0x1a7e>
    3484:	00004517          	auipc	a0,0x4
    3488:	1c450513          	addi	a0,a0,452 # 7648 <malloc+0x19be>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349c:	27058593          	addi	a1,a1,624 # 7708 <malloc+0x1a7e>
    34a0:	00004517          	auipc	a0,0x4
    34a4:	1d850513          	addi	a0,a0,472 # 7678 <malloc+0x19ee>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b8:	00c58593          	addi	a1,a1,12 # 74c0 <malloc+0x1836>
    34bc:	00004517          	auipc	a0,0x4
    34c0:	efc50513          	addi	a0,a0,-260 # 73b8 <malloc+0x172e>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d4:	17850513          	addi	a0,a0,376 # 7648 <malloc+0x19be>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e8:	19450513          	addi	a0,a0,404 # 7678 <malloc+0x19ee>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fc:	fc850513          	addi	a0,a0,-56 # 74c0 <malloc+0x1836>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3510:	16c50513          	addi	a0,a0,364 # 7678 <malloc+0x19ee>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3524:	12850513          	addi	a0,a0,296 # 7648 <malloc+0x19be>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3538:	e8450513          	addi	a0,a0,-380 # 73b8 <malloc+0x172e>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354c:	31050513          	addi	a0,a0,784 # 7858 <malloc+0x1bce>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3560:	f6450513          	addi	a0,a0,-156 # 74c0 <malloc+0x1836>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3574:	e4850513          	addi	a0,a0,-440 # 73b8 <malloc+0x172e>
  ...
  if(unlink("dd") == 0){
    ...
    3588:	e1450513          	addi	a0,a0,-492 # 7398 <malloc+0x170e>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359c:	33050513          	addi	a0,a0,816 # 78c8 <malloc+0x1c3e>
  ...
  if(unlink("dd") < 0){
    ...
    35b0:	dec50513          	addi	a0,a0,-532 # 7398 <malloc+0x170e>
    ...
    35d2:	dd250513          	addi	a0,a0,-558 # 73a0 <malloc+0x1716>
    35d6:	00002097          	auipc	ra,0x2
    35da:	5f6080e7          	jalr	1526(ra) # 5bcc <printf>
    exit(1);
    35de:	4505                	li	a0,1
    ...
    35ee:	dd650513          	addi	a0,a0,-554 # 73c0 <malloc+0x1736>
    35f2:	00002097          	auipc	ra,0x2
    35f6:	5da080e7          	jalr	1498(ra) # 5bcc <printf>
    exit(1);
    35fa:	4505                	li	a0,1
    ...
    360a:	dda50513          	addi	a0,a0,-550 # 73e0 <malloc+0x1756>
    360e:	00002097          	auipc	ra,0x2
    3612:	5be080e7          	jalr	1470(ra) # 5bcc <printf>
    exit(1);
    3616:	4505                	li	a0,1
    ...
    3626:	df650513          	addi	a0,a0,-522 # 7418 <malloc+0x178e>
    362a:	00002097          	auipc	ra,0x2
    362e:	5a2080e7          	jalr	1442(ra) # 5bcc <printf>
    exit(1);
    3632:	4505                	li	a0,1
    ...
    3642:	e0a50513          	addi	a0,a0,-502 # 7448 <malloc+0x17be>
    3646:	00002097          	auipc	ra,0x2
    364a:	586080e7          	jalr	1414(ra) # 5bcc <printf>
    exit(1);
    364e:	4505                	li	a0,1
    ...
    365e:	e2650513          	addi	a0,a0,-474 # 7480 <malloc+0x17f6>
    3662:	00002097          	auipc	ra,0x2
    3666:	56a080e7          	jalr	1386(ra) # 5bcc <printf>
    exit(1);
    366a:	4505                	li	a0,1
    ...
    367a:	e2a50513          	addi	a0,a0,-470 # 74a0 <malloc+0x1816>
    367e:	00002097          	auipc	ra,0x2
    3682:	54e080e7          	jalr	1358(ra) # 5bcc <printf>
    exit(1);
    3686:	4505                	li	a0,1
    ...
    3696:	e3e50513          	addi	a0,a0,-450 # 74d0 <malloc+0x1846>
    369a:	00002097          	auipc	ra,0x2
    369e:	532080e7          	jalr	1330(ra) # 5bcc <printf>
    exit(1);
    36a2:	4505                	li	a0,1
    ...
    36b2:	e4a50513          	addi	a0,a0,-438 # 74f8 <malloc+0x186e>
    36b6:	00002097          	auipc	ra,0x2
    36ba:	516080e7          	jalr	1302(ra) # 5bcc <printf>
    exit(1);
    36be:	4505                	li	a0,1
    ...
    36ce:	e4e50513          	addi	a0,a0,-434 # 7518 <malloc+0x188e>
    36d2:	00002097          	auipc	ra,0x2
    36d6:	4fa080e7          	jalr	1274(ra) # 5bcc <printf>
    exit(1);
    36da:	4505                	li	a0,1
    ...
    36ea:	e5a50513          	addi	a0,a0,-422 # 7540 <malloc+0x18b6>
    36ee:	00002097          	auipc	ra,0x2
    36f2:	4de080e7          	jalr	1246(ra) # 5bcc <printf>
    exit(1);
    36f6:	4505                	li	a0,1
    ...
    3706:	e6650513          	addi	a0,a0,-410 # 7568 <malloc+0x18de>
    370a:	00002097          	auipc	ra,0x2
    370e:	4c2080e7          	jalr	1218(ra) # 5bcc <printf>
    exit(1);
    3712:	4505                	li	a0,1
    ...
    3722:	e7a50513          	addi	a0,a0,-390 # 7598 <malloc+0x190e>
    3726:	00002097          	auipc	ra,0x2
    372a:	4a6080e7          	jalr	1190(ra) # 5bcc <printf>
    exit(1);
    372e:	4505                	li	a0,1
    ...
    373e:	e8650513          	addi	a0,a0,-378 # 75c0 <malloc+0x1936>
    3742:	00002097          	auipc	ra,0x2
    3746:	48a080e7          	jalr	1162(ra) # 5bcc <printf>
    exit(1);
    374a:	4505                	li	a0,1
    ...
    375a:	e8250513          	addi	a0,a0,-382 # 75d8 <malloc+0x194e>
    375e:	00002097          	auipc	ra,0x2
    3762:	46e080e7          	jalr	1134(ra) # 5bcc <printf>
    exit(1);
    3766:	4505                	li	a0,1
    ...
    3776:	e8650513          	addi	a0,a0,-378 # 75f8 <malloc+0x196e>
    377a:	00002097          	auipc	ra,0x2
    377e:	452080e7          	jalr	1106(ra) # 5bcc <printf>
    exit(1);
    3782:	4505                	li	a0,1
    ...
    3792:	e8a50513          	addi	a0,a0,-374 # 7618 <malloc+0x198e>
    3796:	00002097          	auipc	ra,0x2
    379a:	436080e7          	jalr	1078(ra) # 5bcc <printf>
    exit(1);
    379e:	4505                	li	a0,1
    ...
    37ae:	eae50513          	addi	a0,a0,-338 # 7658 <malloc+0x19ce>
    37b2:	00002097          	auipc	ra,0x2
    37b6:	41a080e7          	jalr	1050(ra) # 5bcc <printf>
    exit(1);
    37ba:	4505                	li	a0,1
    ...
    37ca:	ec250513          	addi	a0,a0,-318 # 7688 <malloc+0x19fe>
    37ce:	00002097          	auipc	ra,0x2
    37d2:	3fe080e7          	jalr	1022(ra) # 5bcc <printf>
    exit(1);
    37d6:	4505                	li	a0,1
    ...
    37e6:	ec650513          	addi	a0,a0,-314 # 76a8 <malloc+0x1a1e>
    37ea:	00002097          	auipc	ra,0x2
    37ee:	3e2080e7          	jalr	994(ra) # 5bcc <printf>
    exit(1);
    37f2:	4505                	li	a0,1
    ...
    3802:	eca50513          	addi	a0,a0,-310 # 76c8 <malloc+0x1a3e>
    3806:	00002097          	auipc	ra,0x2
    380a:	3c6080e7          	jalr	966(ra) # 5bcc <printf>
    exit(1);
    380e:	4505                	li	a0,1
    ...
    381e:	ece50513          	addi	a0,a0,-306 # 76e8 <malloc+0x1a5e>
    3822:	00002097          	auipc	ra,0x2
    3826:	3aa080e7          	jalr	938(ra) # 5bcc <printf>
    exit(1);
    382a:	4505                	li	a0,1
    ...
    383a:	ee250513          	addi	a0,a0,-286 # 7718 <malloc+0x1a8e>
    383e:	00002097          	auipc	ra,0x2
    3842:	38e080e7          	jalr	910(ra) # 5bcc <printf>
    exit(1);
    3846:	4505                	li	a0,1
    ...
    3856:	eee50513          	addi	a0,a0,-274 # 7740 <malloc+0x1ab6>
    385a:	00002097          	auipc	ra,0x2
    385e:	372080e7          	jalr	882(ra) # 5bcc <printf>
    exit(1);
    3862:	4505                	li	a0,1
    ...
    3872:	efa50513          	addi	a0,a0,-262 # 7768 <malloc+0x1ade>
    3876:	00002097          	auipc	ra,0x2
    387a:	356080e7          	jalr	854(ra) # 5bcc <printf>
    exit(1);
    387e:	4505                	li	a0,1
    ...
    388e:	f0650513          	addi	a0,a0,-250 # 7790 <malloc+0x1b06>
    3892:	00002097          	auipc	ra,0x2
    3896:	33a080e7          	jalr	826(ra) # 5bcc <printf>
    exit(1);
    389a:	4505                	li	a0,1
    ...
    38aa:	f0a50513          	addi	a0,a0,-246 # 77b0 <malloc+0x1b26>
    38ae:	00002097          	auipc	ra,0x2
    38b2:	31e080e7          	jalr	798(ra) # 5bcc <printf>
    exit(1);
    38b6:	4505                	li	a0,1
    ...
    38c6:	f0e50513          	addi	a0,a0,-242 # 77d0 <malloc+0x1b46>
    38ca:	00002097          	auipc	ra,0x2
    38ce:	302080e7          	jalr	770(ra) # 5bcc <printf>
    exit(1);
    38d2:	4505                	li	a0,1
    ...
    38e2:	f1a50513          	addi	a0,a0,-230 # 77f8 <malloc+0x1b6e>
    38e6:	00002097          	auipc	ra,0x2
    38ea:	2e6080e7          	jalr	742(ra) # 5bcc <printf>
    exit(1);
    38ee:	4505                	li	a0,1
    ...
    38fe:	f1e50513          	addi	a0,a0,-226 # 7818 <malloc+0x1b8e>
    3902:	00002097          	auipc	ra,0x2
    3906:	2ca080e7          	jalr	714(ra) # 5bcc <printf>
    exit(1);
    390a:	4505                	li	a0,1
    ...
    391a:	f2250513          	addi	a0,a0,-222 # 7838 <malloc+0x1bae>
    391e:	00002097          	auipc	ra,0x2
    3922:	2ae080e7          	jalr	686(ra) # 5bcc <printf>
    exit(1);
    3926:	4505                	li	a0,1
    ...
    3936:	f2e50513          	addi	a0,a0,-210 # 7860 <malloc+0x1bd6>
    393a:	00002097          	auipc	ra,0x2
    393e:	292080e7          	jalr	658(ra) # 5bcc <printf>
    exit(1);
    3942:	4505                	li	a0,1
    ...
    3952:	baa50513          	addi	a0,a0,-1110 # 74f8 <malloc+0x186e>
    3956:	00002097          	auipc	ra,0x2
    395a:	276080e7          	jalr	630(ra) # 5bcc <printf>
    exit(1);
    395e:	4505                	li	a0,1
    ...
    396e:	f1650513          	addi	a0,a0,-234 # 7880 <malloc+0x1bf6>
    3972:	00002097          	auipc	ra,0x2
    3976:	25a080e7          	jalr	602(ra) # 5bcc <printf>
    exit(1);
    397a:	4505                	li	a0,1
    ...
    398a:	f1a50513          	addi	a0,a0,-230 # 78a0 <malloc+0x1c16>
    398e:	00002097          	auipc	ra,0x2
    3992:	23e080e7          	jalr	574(ra) # 5bcc <printf>
    exit(1);
    3996:	4505                	li	a0,1
    ...
    39a6:	f2e50513          	addi	a0,a0,-210 # 78d0 <malloc+0x1c46>
    39aa:	00002097          	auipc	ra,0x2
    39ae:	222080e7          	jalr	546(ra) # 5bcc <printf>
    exit(1);
    39b2:	4505                	li	a0,1
    ...
    39c2:	f3250513          	addi	a0,a0,-206 # 78f0 <malloc+0x1c66>
    39c6:	00002097          	auipc	ra,0x2
    39ca:	206080e7          	jalr	518(ra) # 5bcc <printf>
    exit(1);
    39ce:	4505                	li	a0,1
...
00000000000039d8 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e8:	f2450513          	addi	a0,a0,-220 # 7908 <malloc+0x1c7e>
  ...
  if(chdir("dots") != 0){
    ...
    39fa:	f1250513          	addi	a0,a0,-238 # 7908 <malloc+0x1c7e>
  ...
  if(unlink(".") == 0){
    ...
    3a0c:	d9850513          	addi	a0,a0,-616 # 67a0 <malloc+0xb16>
  ...
  if(unlink("..") == 0){
    ...
    3a1e:	94650513          	addi	a0,a0,-1722 # 7360 <malloc+0x16d6>
  ...
  if(chdir("/") != 0){
    ...
    3a30:	8dc50513          	addi	a0,a0,-1828 # 7308 <malloc+0x167e>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a42:	f3250513          	addi	a0,a0,-206 # 7970 <malloc+0x1ce6>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a54:	f4850513          	addi	a0,a0,-184 # 7998 <malloc+0x1d0e>
  ...
  if(unlink("dots") != 0){
    ...
    3a66:	ea650513          	addi	a0,a0,-346 # 7908 <malloc+0x1c7e>
    ...
    3a84:	e9050513          	addi	a0,a0,-368 # 7910 <malloc+0x1c86>
    3a88:	00002097          	auipc	ra,0x2
    3a8c:	144080e7          	jalr	324(ra) # 5bcc <printf>
    exit(1);
    3a90:	4505                	li	a0,1
    ...
    3aa0:	e8c50513          	addi	a0,a0,-372 # 7928 <malloc+0x1c9e>
    3aa4:	00002097          	auipc	ra,0x2
    3aa8:	128080e7          	jalr	296(ra) # 5bcc <printf>
    exit(1);
    3aac:	4505                	li	a0,1
    ...
    3abc:	e8850513          	addi	a0,a0,-376 # 7940 <malloc+0x1cb6>
    3ac0:	00002097          	auipc	ra,0x2
    3ac4:	10c080e7          	jalr	268(ra) # 5bcc <printf>
    exit(1);
    3ac8:	4505                	li	a0,1
    ...
    3ad8:	e8450513          	addi	a0,a0,-380 # 7958 <malloc+0x1cce>
    3adc:	00002097          	auipc	ra,0x2
    3ae0:	0f0080e7          	jalr	240(ra) # 5bcc <printf>
    exit(1);
    3ae4:	4505                	li	a0,1
    ...
    3af4:	82050513          	addi	a0,a0,-2016 # 7310 <malloc+0x1686>
    3af8:	00002097          	auipc	ra,0x2
    3afc:	0d4080e7          	jalr	212(ra) # 5bcc <printf>
    exit(1);
    3b00:	4505                	li	a0,1
    ...
    3b10:	e6c50513          	addi	a0,a0,-404 # 7978 <malloc+0x1cee>
    3b14:	00002097          	auipc	ra,0x2
    3b18:	0b8080e7          	jalr	184(ra) # 5bcc <printf>
    exit(1);
    3b1c:	4505                	li	a0,1
    ...
    3b2c:	e7850513          	addi	a0,a0,-392 # 79a0 <malloc+0x1d16>
    3b30:	00002097          	auipc	ra,0x2
    3b34:	09c080e7          	jalr	156(ra) # 5bcc <printf>
    exit(1);
    3b38:	4505                	li	a0,1
    ...
    3b48:	e7c50513          	addi	a0,a0,-388 # 79c0 <malloc+0x1d36>
    3b4c:	00002097          	auipc	ra,0x2
    3b50:	080080e7          	jalr	128(ra) # 5bcc <printf>
    exit(1);
    3b54:	4505                	li	a0,1
...
0000000000003b5e <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b74:	53850513          	addi	a0,a0,1336 # 60a8 <malloc+0x41e>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b90:	51c50513          	addi	a0,a0,1308 # 60a8 <malloc+0x41e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba4:	e8050513          	addi	a0,a0,-384 # 7a20 <malloc+0x1d96>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bbc:	e6850513          	addi	a0,a0,-408 # 7a20 <malloc+0x1d96>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bd0:	e5450513          	addi	a0,a0,-428 # 7a20 <malloc+0x1d96>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be4:	e4050513          	addi	a0,a0,-448 # 7a20 <malloc+0x1d96>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf8:	e2c58593          	addi	a1,a1,-468 # 7a20 <malloc+0x1d96>
    3bfc:	00002517          	auipc	a0,0x2
    3c00:	6a450513          	addi	a0,a0,1700 # 62a0 <malloc+0x616>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c14:	49850513          	addi	a0,a0,1176 # 60a8 <malloc+0x41e>
  ...
  fd = open(".", O_RDWR);
    ...
    3c2a:	b7a50513          	addi	a0,a0,-1158 # 67a0 <malloc+0xb16>
  ...
  fd = open(".", 0);
    ...
    3c40:	b6450513          	addi	a0,a0,-1180 # 67a0 <malloc+0xb16>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c54:	52858593          	addi	a1,a1,1320 # 6178 <malloc+0x4ee>
  ...
  close(fd);
    ...
    3c80:	d6450513          	addi	a0,a0,-668 # 79e0 <malloc+0x1d56>
    3c84:	00002097          	auipc	ra,0x2
    3c88:	f48080e7          	jalr	-184(ra) # 5bcc <printf>
    exit(1);
    3c8c:	4505                	li	a0,1
    ...
    3c9c:	d6850513          	addi	a0,a0,-664 # 7a00 <malloc+0x1d76>
    3ca0:	00002097          	auipc	ra,0x2
    3ca4:	f2c080e7          	jalr	-212(ra) # 5bcc <printf>
    exit(1);
    3ca8:	4505                	li	a0,1
    ...
    3cb8:	d7c50513          	addi	a0,a0,-644 # 7a30 <malloc+0x1da6>
    3cbc:	00002097          	auipc	ra,0x2
    3cc0:	f10080e7          	jalr	-240(ra) # 5bcc <printf>
    exit(1);
    3cc4:	4505                	li	a0,1
    ...
    3cd4:	d6050513          	addi	a0,a0,-672 # 7a30 <malloc+0x1da6>
    3cd8:	00002097          	auipc	ra,0x2
    3cdc:	ef4080e7          	jalr	-268(ra) # 5bcc <printf>
    exit(1);
    3ce0:	4505                	li	a0,1
    ...
    3cf0:	d6c50513          	addi	a0,a0,-660 # 7a58 <malloc+0x1dce>
    3cf4:	00002097          	auipc	ra,0x2
    3cf8:	ed8080e7          	jalr	-296(ra) # 5bcc <printf>
    exit(1);
    3cfc:	4505                	li	a0,1
    ...
    3d0c:	d7850513          	addi	a0,a0,-648 # 7a80 <malloc+0x1df6>
    3d10:	00002097          	auipc	ra,0x2
    3d14:	ebc080e7          	jalr	-324(ra) # 5bcc <printf>
    exit(1);
    3d18:	4505                	li	a0,1
    ...
    3d28:	d8450513          	addi	a0,a0,-636 # 7aa8 <malloc+0x1e1e>
    3d2c:	00002097          	auipc	ra,0x2
    3d30:	ea0080e7          	jalr	-352(ra) # 5bcc <printf>
    exit(1);
    3d34:	4505                	li	a0,1
    ...
    3d44:	d9050513          	addi	a0,a0,-624 # 7ad0 <malloc+0x1e46>
    3d48:	00002097          	auipc	ra,0x2
    3d4c:	e84080e7          	jalr	-380(ra) # 5bcc <printf>
    exit(1);
    3d50:	4505                	li	a0,1
    ...
    3d60:	d9450513          	addi	a0,a0,-620 # 7af0 <malloc+0x1e66>
    3d64:	00002097          	auipc	ra,0x2
    3d68:	e68080e7          	jalr	-408(ra) # 5bcc <printf>
    exit(1);
    3d6c:	4505                	li	a0,1
    ...
    3d7c:	da050513          	addi	a0,a0,-608 # 7b18 <malloc+0x1e8e>
    3d80:	00002097          	auipc	ra,0x2
    3d84:	e4c080e7          	jalr	-436(ra) # 5bcc <printf>
    exit(1);
    3d88:	4505                	li	a0,1
...
0000000000003d92 <iref>:
{
    ...
    3db0:	d84a0a13          	addi	s4,s4,-636 # 7b30 <malloc+0x1ea6>
    mkdir("");
    3db4:	00004497          	auipc	s1,0x4
    3db8:	88c48493          	addi	s1,s1,-1908 # 7640 <malloc+0x19b6>
    link("README", "");
    3dbc:	00002a97          	auipc	s5,0x2
    3dc0:	4e4a8a93          	addi	s5,s5,1252 # 62a0 <malloc+0x616>
    fd = open("xx", O_CREATE);
    3dc4:	00004997          	auipc	s3,0x4
    3dc8:	c6498993          	addi	s3,s3,-924 # 7a28 <malloc+0x1d9e>
    3dcc:	a891                	j	3e20 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dce:	85da                	mv	a1,s6
    3dd0:	00004517          	auipc	a0,0x4
    3dd4:	d6850513          	addi	a0,a0,-664 # 7b38 <malloc+0x1eae>
    3dd8:	00002097          	auipc	ra,0x2
    3ddc:	df4080e7          	jalr	-524(ra) # 5bcc <printf>
      exit(1);
    3de0:	4505                	li	a0,1
    ...
    3df0:	d6450513          	addi	a0,a0,-668 # 7b50 <malloc+0x1ec6>
    3df4:	00002097          	auipc	ra,0x2
    3df8:	dd8080e7          	jalr	-552(ra) # 5bcc <printf>
      exit(1);
    3dfc:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e84:	4e098993          	addi	s3,s3,1248 # 7360 <malloc+0x16d6>
    unlink("irefd");
    3e88:	00004917          	auipc	s2,0x4
    3e8c:	ca890913          	addi	s2,s2,-856 # 7b30 <malloc+0x1ea6>
    chdir("..");
    3e90:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eac:	46050513          	addi	a0,a0,1120 # 7308 <malloc+0x167e>
...
0000000000003ecc <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3edc:	c9050513          	addi	a0,a0,-880 # 7b68 <malloc+0x1ede>
  ...
  if(pid == 0){
    ...
    3f00:	c6c50513          	addi	a0,a0,-916 # 7b68 <malloc+0x1ede>
    ...
    3f16:	c7650513          	addi	a0,a0,-906 # 7b88 <malloc+0x1efe>
    3f1a:	00002097          	auipc	ra,0x2
    3f1e:	cb2080e7          	jalr	-846(ra) # 5bcc <printf>
      exit(1);
    3f22:	4505                	li	a0,1
    ...
    3f32:	c4250513          	addi	a0,a0,-958 # 7b70 <malloc+0x1ee6>
    3f36:	00002097          	auipc	ra,0x2
    3f3a:	c96080e7          	jalr	-874(ra) # 5bcc <printf>
    exit(1);
    3f3e:	4505                	li	a0,1
    ...
    3f4e:	9f650513          	addi	a0,a0,-1546 # 6940 <malloc+0xcb6>
    3f52:	00002097          	auipc	ra,0x2
    3f56:	c7a080e7          	jalr	-902(ra) # 5bcc <printf>
    exit(1);
    3f5a:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f7c:	bf050513          	addi	a0,a0,-1040 # 7b68 <malloc+0x1ede>
    ...
    3f90:	ba450513          	addi	a0,a0,-1116 # 6b30 <malloc+0xea6>
    3f94:	00002097          	auipc	ra,0x2
    3f98:	c38080e7          	jalr	-968(ra) # 5bcc <printf>
    exit(1);
    3f9c:	4505                	li	a0,1
...
0000000000003fbe <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fce:	be650513          	addi	a0,a0,-1050 # 7bb0 <malloc+0x1f26>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ffa:	bba50513          	addi	a0,a0,-1094 # 7bb0 <malloc+0x1f26>
  ...
  sleep(10); // one second
    ...
    4032:	ad250513          	addi	a0,a0,-1326 # 6b00 <malloc+0xe76>
    4036:	00002097          	auipc	ra,0x2
    403a:	b96080e7          	jalr	-1130(ra) # 5bcc <printf>
    exit(1);
    403e:	4505                	li	a0,1
    ...
    404c:	b6848493          	addi	s1,s1,-1176 # 7bb0 <malloc+0x1f26>
    4050:	4581                	li	a1,0
    4052:	8526                	mv	a0,s1
...
000000000000408e <killstatus>:
{
  ...
  exit(0);
    ...
    40f4:	85050513          	addi	a0,a0,-1968 # 6940 <malloc+0xcb6>
    40f8:	00002097          	auipc	ra,0x2
    40fc:	ad4080e7          	jalr	-1324(ra) # 5bcc <printf>
      exit(1);
    4100:	4505                	li	a0,1
    ...
    411a:	aaa50513          	addi	a0,a0,-1366 # 7bc0 <malloc+0x1f36>
    411e:	00002097          	auipc	ra,0x2
    4122:	aae080e7          	jalr	-1362(ra) # 5bcc <printf>
       exit(1);
    4126:	4505                	li	a0,1
...
0000000000004130 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    415a:	9aa50513          	addi	a0,a0,-1622 # 6b00 <malloc+0xe76>
    415e:	00002097          	auipc	ra,0x2
    4162:	a6e080e7          	jalr	-1426(ra) # 5bcc <printf>
    exit(1);
    4166:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4188:	7bc50513          	addi	a0,a0,1980 # 6940 <malloc+0xcb6>
    418c:	00002097          	auipc	ra,0x2
    4190:	a40080e7          	jalr	-1472(ra) # 5bcc <printf>
    exit(1);
    4194:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41cc:	fb058593          	addi	a1,a1,-80 # 6178 <malloc+0x4ee>
    ...
    41f6:	74e50513          	addi	a0,a0,1870 # 6940 <malloc+0xcb6>
    41fa:	00002097          	auipc	ra,0x2
    41fe:	9d2080e7          	jalr	-1582(ra) # 5bcc <printf>
     exit(1);
    4202:	4505                	li	a0,1
    ...
    4212:	9d250513          	addi	a0,a0,-1582 # 7be0 <malloc+0x1f56>
    4216:	00002097          	auipc	ra,0x2
    421a:	9b6080e7          	jalr	-1610(ra) # 5bcc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4232:	b6258593          	addi	a1,a1,-1182 # bd90 <buf>
    ...
    424e:	9ae50513          	addi	a0,a0,-1618 # 7bf8 <malloc+0x1f6e>
    4252:	00002097          	auipc	ra,0x2
    4256:	97a080e7          	jalr	-1670(ra) # 5bcc <printf>
}
  ...
  printf("kill... ");
    ...
    427a:	99a50513          	addi	a0,a0,-1638 # 7c10 <malloc+0x1f86>
    427e:	00002097          	auipc	ra,0x2
    4282:	94e080e7          	jalr	-1714(ra) # 5bcc <printf>
  kill(pid1);
    4286:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    42a8:	97c50513          	addi	a0,a0,-1668 # 7c20 <malloc+0x1f96>
    42ac:	00002097          	auipc	ra,0x2
    42b0:	920080e7          	jalr	-1760(ra) # 5bcc <printf>
  wait(0);
    42b4:	4501                	li	a0,0
...
00000000000042d4 <reparent>:
{
  ...
  exit(0);
    ...
    4328:	61c50513          	addi	a0,a0,1564 # 6940 <malloc+0xcb6>
    432c:	00002097          	auipc	ra,0x2
    4330:	8a0080e7          	jalr	-1888(ra) # 5bcc <printf>
      exit(1);
    4334:	4505                	li	a0,1
    ...
    4344:	78850513          	addi	a0,a0,1928 # 6ac8 <malloc+0xe3e>
    4348:	00002097          	auipc	ra,0x2
    434c:	884080e7          	jalr	-1916(ra) # 5bcc <printf>
        exit(1);
    4350:	4505                	li	a0,1
...
0000000000004384 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43ba:	69250513          	addi	a0,a0,1682 # 6a48 <malloc+0xdbe>
    43be:	00002097          	auipc	ra,0x2
    43c2:	80e080e7          	jalr	-2034(ra) # 5bcc <printf>
    exit(1);
    43c6:	4505                	li	a0,1
    ...
    43f0:	d8c58593          	addi	a1,a1,-628 # 6178 <malloc+0x4ee>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b4:	78050513          	addi	a0,a0,1920 # 7c30 <malloc+0x1fa6>
    44b8:	00001097          	auipc	ra,0x1
    44bc:	714080e7          	jalr	1812(ra) # 5bcc <printf>
    exit(1);
    44c0:	4505                	li	a0,1
    ...
    44d0:	47450513          	addi	a0,a0,1140 # 6940 <malloc+0xcb6>
    44d4:	00001097          	auipc	ra,0x1
    44d8:	6f8080e7          	jalr	1784(ra) # 5bcc <printf>
    exit(1);
    44dc:	4505                	li	a0,1
    ...
    451c:	73850513          	addi	a0,a0,1848 # 7c50 <malloc+0x1fc6>
    4520:	00001097          	auipc	ra,0x1
    4524:	6ac080e7          	jalr	1708(ra) # 5bcc <printf>
    exit(1);
    4528:	4505                	li	a0,1
...
000000000000453c <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4564:	72a080e7          	jalr	1834(ra) # 5c8a <malloc>
    ...
    45a4:	6e050513          	addi	a0,a0,1760 # 7c80 <malloc+0x1ff6>
    45a8:	00001097          	auipc	ra,0x1
    45ac:	624080e7          	jalr	1572(ra) # 5bcc <printf>
      exit(1);
    45b0:	4505                	li	a0,1
...
00000000000045e2 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4678:	62c50513          	addi	a0,a0,1580 # 7ca0 <malloc+0x2016>
    467c:	00001097          	auipc	ra,0x1
    4680:	550080e7          	jalr	1360(ra) # 5bcc <printf>
    exit(1);
    4684:	4505                	li	a0,1
    ...
    4694:	63850513          	addi	a0,a0,1592 # 7cc8 <malloc+0x203e>
    4698:	00001097          	auipc	ra,0x1
    469c:	534080e7          	jalr	1332(ra) # 5bcc <printf>
      exit(1);
    46a0:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d8:	84450513          	addi	a0,a0,-1980 # 5f18 <malloc+0x28e>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4718:	5d450513          	addi	a0,a0,1492 # 7ce8 <malloc+0x205e>
    471c:	00001097          	auipc	ra,0x1
    4720:	4b0080e7          	jalr	1200(ra) # 5bcc <printf>
    exit(1);
    4724:	4505                	li	a0,1
    ...
    4732:	fd2783e3          	beq	a5,s2,46f8 <sharedfd+0x116>
      if(buf[i] == 'c')
    4736:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1260>
  ...
  unlink("sharedfd");
    ...
    4754:	7c850513          	addi	a0,a0,1992 # 5f18 <malloc+0x28e>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    477a:	59a50513          	addi	a0,a0,1434 # 7d10 <malloc+0x2086>
    477e:	00001097          	auipc	ra,0x1
    4782:	44e080e7          	jalr	1102(ra) # 5bcc <printf>
    exit(1);
    4786:	4505                	li	a0,1
...
000000000000479a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47be:	5b678793          	addi	a5,a5,1462 # 5d70 <malloc+0xe6>
    47c2:	f6f43823          	sd	a5,-144(s0)
    47c6:	00001797          	auipc	a5,0x1
    47ca:	5b278793          	addi	a5,a5,1458 # 5d78 <malloc+0xee>
    47ce:	f6f43c23          	sd	a5,-136(s0)
    47d2:	00001797          	auipc	a5,0x1
    47d6:	5ae78793          	addi	a5,a5,1454 # 5d80 <malloc+0xf6>
    47da:	f8f43023          	sd	a5,-128(s0)
    47de:	00001797          	auipc	a5,0x1
    47e2:	5aa78793          	addi	a5,a5,1450 # 5d88 <malloc+0xfe>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483c:	558a0a13          	addi	s4,s4,1368 # bd90 <buf>
    4840:	00007a97          	auipc	s5,0x7
    4844:	551a8a93          	addi	s5,s5,1361 # bd91 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    485a:	50a50513          	addi	a0,a0,1290 # 6d60 <malloc+0x10d6>
    485e:	00001097          	auipc	ra,0x1
    4862:	36e080e7          	jalr	878(ra) # 5bcc <printf>
      exit(1);
    4866:	4505                	li	a0,1
    ...
    48d4:	45850513          	addi	a0,a0,1112 # 7d28 <malloc+0x209e>
    48d8:	00001097          	auipc	ra,0x1
    48dc:	2f4080e7          	jalr	756(ra) # 5bcc <printf>
        exit(1);
    48e0:	4505                	li	a0,1
    ...
    48ee:	44e50513          	addi	a0,a0,1102 # 7d38 <malloc+0x20ae>
    48f2:	00001097          	auipc	ra,0x1
    48f6:	2da080e7          	jalr	730(ra) # 5bcc <printf>
          exit(1);
    48fa:	4505                	li	a0,1
    ...
    4912:	44250513          	addi	a0,a0,1090 # 7d50 <malloc+0x20c6>
    4916:	00001097          	auipc	ra,0x1
    491a:	2b6080e7          	jalr	694(ra) # 5bcc <printf>
          exit(1);
    491e:	4505                	li	a0,1
    ...
    4942:	45278793          	addi	a5,a5,1106 # bd90 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a2:	3c250513          	addi	a0,a0,962 # 7d60 <malloc+0x20d6>
    49a6:	00001097          	auipc	ra,0x1
    49aa:	226080e7          	jalr	550(ra) # 5bcc <printf>
      exit(1);
    49ae:	4505                	li	a0,1
...
00000000000049d6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a04:	378b8b93          	addi	s7,s7,888 # 7d78 <malloc+0x20ee>
  for(i = 0; i < N; i++){
    ...
    4a46:	33e50513          	addi	a0,a0,830 # 7d80 <malloc+0x20f6>
    4a4a:	00001097          	auipc	ra,0x1
    4a4e:	182080e7          	jalr	386(ra) # 5bcc <printf>
        exit(1);
    4a52:	4505                	li	a0,1
    ...
    4a64:	31850513          	addi	a0,a0,792 # 7d78 <malloc+0x20ee>
  ...
  fd = open(".", 0);
    ...
    4a9c:	d0850513          	addi	a0,a0,-760 # 67a0 <malloc+0xb16>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac2:	2e250513          	addi	a0,a0,738 # 7da0 <malloc+0x2116>
    4ac6:	00001097          	auipc	ra,0x1
    4aca:	106080e7          	jalr	262(ra) # 5bcc <printf>
        exit(1);
    4ace:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b32:	29250513          	addi	a0,a0,658 # 7dc0 <malloc+0x2136>
    4b36:	00001097          	auipc	ra,0x1
    4b3a:	096080e7          	jalr	150(ra) # 5bcc <printf>
        exit(1);
    4b3e:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b6a:	28250513          	addi	a0,a0,642 # 7de8 <malloc+0x215e>
    4b6e:	00001097          	auipc	ra,0x1
    4b72:	05e080e7          	jalr	94(ra) # 5bcc <printf>
    exit(1);
    4b76:	4505                	li	a0,1
    ...
    4b86:	dbe50513          	addi	a0,a0,-578 # 6940 <malloc+0xcb6>
    4b8a:	00001097          	auipc	ra,0x1
    4b8e:	042080e7          	jalr	66(ra) # 5bcc <printf>
      exit(1);
    4b92:	4505                	li	a0,1
...
0000000000004d30 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d70:	02490913          	addi	s2,s2,36 # bd90 <buf>
  for(i = 0; i < N; i++){
    4d74:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db8:	06c50513          	addi	a0,a0,108 # 7e20 <malloc+0x2196>
  ...
  for(i = 0; ; i++){
    ...
    4dce:	fc690913          	addi	s2,s2,-58 # bd90 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e1c:	01850513          	addi	a0,a0,24 # 7e30 <malloc+0x21a6>
    4e20:	00001097          	auipc	ra,0x1
    4e24:	dac080e7          	jalr	-596(ra) # 5bcc <printf>
    exit(1);
    4e28:	4505                	li	a0,1
    ...
    4e38:	01c50513          	addi	a0,a0,28 # 7e50 <malloc+0x21c6>
    4e3c:	00001097          	auipc	ra,0x1
    4e40:	d90080e7          	jalr	-624(ra) # 5bcc <printf>
      exit(1);
    4e44:	4505                	li	a0,1
    ...
    4e54:	02050513          	addi	a0,a0,32 # 7e70 <malloc+0x21e6>
    4e58:	00001097          	auipc	ra,0x1
    4e5c:	d74080e7          	jalr	-652(ra) # 5bcc <printf>
    exit(1);
    4e60:	4505                	li	a0,1
    ...
    4e70:	02450513          	addi	a0,a0,36 # 7e90 <malloc+0x2206>
    4e74:	00001097          	auipc	ra,0x1
    4e78:	d58080e7          	jalr	-680(ra) # 5bcc <printf>
      exit(1);
    4e7c:	4505                	li	a0,1
    ...
    4e8c:	02850513          	addi	a0,a0,40 # 7eb0 <malloc+0x2226>
    4e90:	00001097          	auipc	ra,0x1
    4e94:	d3c080e7          	jalr	-708(ra) # 5bcc <printf>
      exit(1);
    4e98:	4505                	li	a0,1
    ...
    4ea8:	02450513          	addi	a0,a0,36 # 7ec8 <malloc+0x223e>
    4eac:	00001097          	auipc	ra,0x1
    4eb0:	d20080e7          	jalr	-736(ra) # 5bcc <printf>
      exit(1);
    4eb4:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed6:	f4e50513          	addi	a0,a0,-178 # 7e20 <malloc+0x2196>
    ...
    4efa:	ff250513          	addi	a0,a0,-14 # 7ee8 <malloc+0x225e>
    4efe:	00001097          	auipc	ra,0x1
    4f02:	cce080e7          	jalr	-818(ra) # 5bcc <printf>
    exit(1);
    4f06:	4505                	li	a0,1
...
0000000000004f10 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f32:	fda50513          	addi	a0,a0,-38 # 7f08 <malloc+0x227e>
    4f36:	00001097          	auipc	ra,0x1
    4f3a:	c96080e7          	jalr	-874(ra) # 5bcc <printf>
  for(nfiles = 0; ; nfiles++){
    4f3e:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f52:	fcac8c93          	addi	s9,s9,-54 # 7f18 <malloc+0x228e>
    int total = 0;
    4f56:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f58:	00007a17          	auipc	s4,0x7
    4f5c:	e38a0a13          	addi	s4,s4,-456 # bd90 <buf>
    name[0] = 'f';
    ...
    4faa:	c26080e7          	jalr	-986(ra) # 5bcc <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fcc:	f6050513          	addi	a0,a0,-160 # 7f28 <malloc+0x229e>
    4fd0:	00001097          	auipc	ra,0x1
    4fd4:	bfc080e7          	jalr	-1028(ra) # 5bcc <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5042:	f0a50513          	addi	a0,a0,-246 # 7f48 <malloc+0x22be>
    5046:	00001097          	auipc	ra,0x1
    504a:	b86080e7          	jalr	-1146(ra) # 5bcc <printf>
}
    ...
    5092:	eaa50513          	addi	a0,a0,-342 # 7f38 <malloc+0x22ae>
    5096:	00001097          	auipc	ra,0x1
    509a:	b36080e7          	jalr	-1226(ra) # 5bcc <printf>
    close(fd);
    509e:	854a                	mv	a0,s2
...
00000000000050b0 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5124:	e4050513          	addi	a0,a0,-448 # 7f60 <malloc+0x22d6>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513c:	04058593          	addi	a1,a1,64 # 6178 <malloc+0x4ee>
    ...
    5152:	e3250513          	addi	a0,a0,-462 # 7f80 <malloc+0x22f6>
    5156:	00001097          	auipc	ra,0x1
    515a:	a76080e7          	jalr	-1418(ra) # 5bcc <printf>
    exit(1);
    515e:	4505                	li	a0,1
    ...
    516c:	e0050513          	addi	a0,a0,-512 # 7f68 <malloc+0x22de>
    5170:	00001097          	auipc	ra,0x1
    5174:	a5c080e7          	jalr	-1444(ra) # 5bcc <printf>
      exit(1);
    5178:	4505                	li	a0,1
    ...
    5186:	de650513          	addi	a0,a0,-538 # 7f68 <malloc+0x22de>
    518a:	00001097          	auipc	ra,0x1
    518e:	a42080e7          	jalr	-1470(ra) # 5bcc <printf>
    exit(1);
    5192:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51aa:	dba50513          	addi	a0,a0,-582 # 7f60 <malloc+0x22d6>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5200:	f7c90913          	addi	s2,s2,-132 # 6178 <malloc+0x4ee>
      uint64 a = (uint64) sbrk(4096);
    ...
    5234:	da050513          	addi	a0,a0,-608 # 7fd0 <malloc+0x2346>
    5238:	00001097          	auipc	ra,0x1
    523c:	994080e7          	jalr	-1644(ra) # 5bcc <printf>
        exit(1);
    5240:	4505                	li	a0,1
    ...
    524e:	d4650513          	addi	a0,a0,-698 # 7f90 <malloc+0x2306>
    5252:	00001097          	auipc	ra,0x1
    5256:	97a080e7          	jalr	-1670(ra) # 5bcc <printf>
    exit(1);
    525a:	4505                	li	a0,1
    ...
    5268:	d4c50513          	addi	a0,a0,-692 # 7fb0 <malloc+0x2326>
    526c:	00001097          	auipc	ra,0x1
    5270:	960080e7          	jalr	-1696(ra) # 5bcc <printf>
    exit(1);
    5274:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b6:	d3e50513          	addi	a0,a0,-706 # 7ff0 <malloc+0x2366>
    52ba:	00001097          	auipc	ra,0x1
    52be:	912080e7          	jalr	-1774(ra) # 5bcc <printf>
      exit(1);
    52c2:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5306:	d0e50513          	addi	a0,a0,-754 # 8010 <malloc+0x2386>
    530a:	00001097          	auipc	ra,0x1
    530e:	8c2080e7          	jalr	-1854(ra) # 5bcc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5336:	d0650513          	addi	a0,a0,-762 # 8038 <malloc+0x23ae>
    533a:	00001097          	auipc	ra,0x1
    533e:	892080e7          	jalr	-1902(ra) # 5bcc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    535a:	cca50513          	addi	a0,a0,-822 # 8020 <malloc+0x2396>
    535e:	00001097          	auipc	ra,0x1
    5362:	86e080e7          	jalr	-1938(ra) # 5bcc <printf>
    exit(1);
    5366:	4505                	li	a0,1
    ...
    5382:	cc250513          	addi	a0,a0,-830 # 8040 <malloc+0x23b6>
    5386:	00001097          	auipc	ra,0x1
    538a:	846080e7          	jalr	-1978(ra) # 5bcc <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53cc:	d9078793          	addi	a5,a5,-624 # 8158 <malloc+0x24ce>
    53d0:	bd040713          	addi	a4,s0,-1072
    53d4:	00003317          	auipc	t1,0x3
    53d8:	17430313          	addi	t1,t1,372 # 8548 <malloc+0x28be>
  ...
  printf("usertests starting\n");
    ...
    540c:	cf050513          	addi	a0,a0,-784 # 80f8 <malloc+0x246e>
    5410:	00000097          	auipc	ra,0x0
    5414:	7bc080e7          	jalr	1980(ra) # 5bcc <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5444:	c7050513          	addi	a0,a0,-912 # 80b0 <malloc+0x2426>
    5448:	00000097          	auipc	ra,0x0
    544c:	784080e7          	jalr	1924(ra) # 5bcc <printf>
    exit(1);
    5450:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5460:	bec58593          	addi	a1,a1,-1044 # 8048 <malloc+0x23be>
    ...
    5476:	cbe58593          	addi	a1,a1,-834 # 8130 <malloc+0x24a6>
    ...
    549a:	bba50513          	addi	a0,a0,-1094 # 8050 <malloc+0x23c6>
    549e:	00000097          	auipc	ra,0x0
    54a2:	72e080e7          	jalr	1838(ra) # 5bcc <printf>
    exit(1);
    54a6:	4505                	li	a0,1
    ...
    54c4:	70c080e7          	jalr	1804(ra) # 5bcc <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5506:	b9650513          	addi	a0,a0,-1130 # 8098 <malloc+0x240e>
    550a:	00000097          	auipc	ra,0x0
    550e:	6c2080e7          	jalr	1730(ra) # 5bcc <printf>
    exit(1);
    5512:	4505                	li	a0,1
    ...
    5520:	bc450513          	addi	a0,a0,-1084 # 80e0 <malloc+0x2456>
    5524:	00000097          	auipc	ra,0x0
    5528:	6a8080e7          	jalr	1704(ra) # 5bcc <printf>
    exit(0);
    552c:	4501                	li	a0,0
    ...
    553c:	694080e7          	jalr	1684(ra) # 5bcc <printf>
        if(continuous != 2)
    ...
    557e:	bde78793          	addi	a5,a5,-1058 # 8158 <malloc+0x24ce>
    5582:	bd040713          	addi	a4,s0,-1072
    5586:	00003317          	auipc	t1,0x3
    558a:	fc230313          	addi	t1,t1,-62 # 8548 <malloc+0x28be>
    ...
    55be:	b5650513          	addi	a0,a0,-1194 # 8110 <malloc+0x2486>
    55c2:	00000097          	auipc	ra,0x0
    55c6:	60a080e7          	jalr	1546(ra) # 5bcc <printf>
        printf("SOME TESTS FAILED\n");
    55ca:	00003a97          	auipc	s5,0x3
    55ce:	acea8a93          	addi	s5,s5,-1330 # 8098 <malloc+0x240e>
        if(continuous != 2)
    55d2:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d4:	00003b17          	auipc	s6,0x3
    55d8:	aa4b0b13          	addi	s6,s6,-1372 # 8078 <malloc+0x23ee>
...
putc(int fd, char c)
{
    58f4:	1101                	addi	sp,sp,-32
    58f6:	ec06                	sd	ra,24(sp)
    58f8:	e822                	sd	s0,16(sp)
    58fa:	1000                	addi	s0,sp,32
    58fc:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5900:	4605                	li	a2,1
    5902:	fef40593          	addi	a1,s0,-17
    5906:	00000097          	auipc	ra,0x0
    590a:	f6e080e7          	jalr	-146(ra) # 5874 <write>
}
    590e:	60e2                	ld	ra,24(sp)
    5910:	6442                	ld	s0,16(sp)
    5912:	6105                	addi	sp,sp,32
    5914:	8082                	ret

0000000000005916 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    5926:	c299                	beqz	a3,592c <printint+0x16>
    5928:	0805c863          	bltz	a1,59b8 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    592c:	2581                	sext.w	a1,a1
  neg = 0;
    592e:	4881                	li	a7,0
    5930:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5936:	2601                	sext.w	a2,a2
    5938:	00003517          	auipc	a0,0x3
    593c:	c1850513          	addi	a0,a0,-1000 # 8550 <digits>
    5940:	883a                	mv	a6,a4
    5942:	2705                	addiw	a4,a4,1
    5944:	02c5f7bb          	remuw	a5,a1,a2
    5948:	1782                	slli	a5,a5,0x20
    594a:	9381                	srli	a5,a5,0x20
    594c:	97aa                	add	a5,a5,a0
    594e:	0007c783          	lbu	a5,0(a5)
    5952:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5956:	0005879b          	sext.w	a5,a1
    595a:	02c5d5bb          	divuw	a1,a1,a2
    595e:	0685                	addi	a3,a3,1
    5960:	fec7f0e3          	bgeu	a5,a2,5940 <printint+0x2a>
  if(neg)
    5964:	00088b63          	beqz	a7,597a <printint+0x64>
    buf[i++] = '-';
    5968:	fd040793          	addi	a5,s0,-48
    596c:	973e                	add	a4,a4,a5
    596e:	02d00793          	li	a5,45
    5972:	fef70823          	sb	a5,-16(a4)
    5976:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    597a:	02e05863          	blez	a4,59aa <printint+0x94>
    ...
    59a0:	f58080e7          	jalr	-168(ra) # 58f4 <putc>
  while(--i >= 0)
    59a4:	197d                	addi	s2,s2,-1
    59a6:	ff3918e3          	bne	s2,s3,5996 <printint+0x80>
}
    ...
    59bc:	4885                	li	a7,1
    x = -xx;
    59be:	bf8d                	j	5930 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    59f0:	02500a13          	li	s4,37
      if(c == 'd'){
    59f4:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    59f8:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    59fc:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a00:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a04:	00003b97          	auipc	s7,0x3
    5a08:	b4cb8b93          	addi	s7,s7,-1204 # 8550 <digits>
    5a0c:	a839                	j	5a2a <vprintf+0x6a>
        putc(fd, c);
    5a0e:	85ca                	mv	a1,s2
    5a10:	8556                	mv	a0,s5
    5a12:	00000097          	auipc	ra,0x0
    5a16:	ee2080e7          	jalr	-286(ra) # 58f4 <putc>
    5a1a:	a019                	j	5a20 <vprintf+0x60>
    } else if(state == '%'){
    5a1c:	01498f63          	beq	s3,s4,5a3a <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a20:	0485                	addi	s1,s1,1
    5a22:	fff4c903          	lbu	s2,-1(s1)
    5a26:	14090d63          	beqz	s2,5b80 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a2a:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a2e:	fe0997e3          	bnez	s3,5a1c <vprintf+0x5c>
      if(c == '%'){
    5a32:	fd479ee3          	bne	a5,s4,5a0e <vprintf+0x4e>
        state = '%';
    5a36:	89be                	mv	s3,a5
    5a38:	b7e5                	j	5a20 <vprintf+0x60>
      if(c == 'd'){
    5a3a:	05878063          	beq	a5,s8,5a7a <vprintf+0xba>
      } else if(c == 'l') {
    5a3e:	05978c63          	beq	a5,s9,5a96 <vprintf+0xd6>
      } else if(c == 'x') {
    5a42:	07a78863          	beq	a5,s10,5ab2 <vprintf+0xf2>
      } else if(c == 'p') {
    5a46:	09b78463          	beq	a5,s11,5ace <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a4a:	07300713          	li	a4,115
    5a4e:	0ce78663          	beq	a5,a4,5b1a <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a52:	06300713          	li	a4,99
    5a56:	0ee78e63          	beq	a5,a4,5b52 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5a5a:	11478863          	beq	a5,s4,5b6a <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5a66:	e92080e7          	jalr	-366(ra) # 58f4 <putc>
        putc(fd, c);
    5a6a:	85ca                	mv	a1,s2
    5a6c:	8556                	mv	a0,s5
    5a6e:	00000097          	auipc	ra,0x0
    5a72:	e86080e7          	jalr	-378(ra) # 58f4 <putc>
      }
      state = 0;
    5a76:	4981                	li	s3,0
    ...
    5a8c:	e8e080e7          	jalr	-370(ra) # 5916 <printint>
    5a90:	8b4a                	mv	s6,s2
      state = 0;
    5a92:	4981                	li	s3,0
    ...
    5aa8:	e72080e7          	jalr	-398(ra) # 5916 <printint>
    5aac:	8b4a                	mv	s6,s2
      state = 0;
    5aae:	4981                	li	s3,0
    ...
    5ac4:	e56080e7          	jalr	-426(ra) # 5916 <printint>
    5ac8:	8b4a                	mv	s6,s2
      state = 0;
    5aca:	4981                	li	s3,0
    5acc:	bf91                	j	5a20 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5ace:	008b0793          	addi	a5,s6,8
    5ad2:	f8f43423          	sd	a5,-120(s0)
    5ad6:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5ada:	03000593          	li	a1,48
    5ade:	8556                	mv	a0,s5
    5ae0:	00000097          	auipc	ra,0x0
    5ae4:	e14080e7          	jalr	-492(ra) # 58f4 <putc>
  putc(fd, 'x');
    5ae8:	85ea                	mv	a1,s10
    5aea:	8556                	mv	a0,s5
    5aec:	00000097          	auipc	ra,0x0
    5af0:	e08080e7          	jalr	-504(ra) # 58f4 <putc>
    5af4:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5af6:	03c9d793          	srli	a5,s3,0x3c
    5afa:	97de                	add	a5,a5,s7
    5afc:	0007c583          	lbu	a1,0(a5)
    5b00:	8556                	mv	a0,s5
    5b02:	00000097          	auipc	ra,0x0
    5b06:	df2080e7          	jalr	-526(ra) # 58f4 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b0a:	0992                	slli	s3,s3,0x4
    5b0c:	397d                	addiw	s2,s2,-1
    5b0e:	fe0914e3          	bnez	s2,5af6 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b12:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b16:	4981                	li	s3,0
    5b18:	b721                	j	5a20 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b1a:	008b0993          	addi	s3,s6,8
    5b1e:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b22:	02090163          	beqz	s2,5b44 <vprintf+0x184>
        while(*s != 0){
    5b26:	00094583          	lbu	a1,0(s2)
    5b2a:	c9a1                	beqz	a1,5b7a <vprintf+0x1ba>
          putc(fd, *s);
    5b2c:	8556                	mv	a0,s5
    5b2e:	00000097          	auipc	ra,0x0
    5b32:	dc6080e7          	jalr	-570(ra) # 58f4 <putc>
          s++;
    5b36:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b38:	00094583          	lbu	a1,0(s2)
    5b3c:	f9e5                	bnez	a1,5b2c <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b3e:	8b4e                	mv	s6,s3
      state = 0;
    5b40:	4981                	li	s3,0
    5b42:	bdf9                	j	5a20 <vprintf+0x60>
          s = "(null)";
    5b44:	00003917          	auipc	s2,0x3
    5b48:	a0490913          	addi	s2,s2,-1532 # 8548 <malloc+0x28be>
        while(*s != 0){
    5b4c:	02800593          	li	a1,40
    5b50:	bff1                	j	5b2c <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b52:	008b0913          	addi	s2,s6,8
    5b56:	000b4583          	lbu	a1,0(s6)
    5b5a:	8556                	mv	a0,s5
    5b5c:	00000097          	auipc	ra,0x0
    5b60:	d98080e7          	jalr	-616(ra) # 58f4 <putc>
    5b64:	8b4a                	mv	s6,s2
      state = 0;
    5b66:	4981                	li	s3,0
    5b68:	bd65                	j	5a20 <vprintf+0x60>
        putc(fd, c);
    5b6a:	85d2                	mv	a1,s4
    5b6c:	8556                	mv	a0,s5
    5b6e:	00000097          	auipc	ra,0x0
    5b72:	d86080e7          	jalr	-634(ra) # 58f4 <putc>
      state = 0;
    5b76:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5c10:	9647b783          	ld	a5,-1692(a5) # 8570 <freep>
    5c14:	a805                	j	5c44 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c16:	4618                	lw	a4,8(a2)
    5c18:	9db9                	addw	a1,a1,a4
    5c1a:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c1e:	6398                	ld	a4,0(a5)
    5c20:	6318                	ld	a4,0(a4)
    5c22:	fee53823          	sd	a4,-16(a0)
    5c26:	a091                	j	5c6a <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c28:	ff852703          	lw	a4,-8(a0)
    5c2c:	9e39                	addw	a2,a2,a4
    5c2e:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c30:	ff053703          	ld	a4,-16(a0)
    5c34:	e398                	sd	a4,0(a5)
    5c36:	a099                	j	5c7c <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c38:	6398                	ld	a4,0(a5)
    5c3a:	00e7e463          	bltu	a5,a4,5c42 <free+0x40>
    5c3e:	00e6ea63          	bltu	a3,a4,5c52 <free+0x50>
{
    5c42:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c44:	fed7fae3          	bgeu	a5,a3,5c38 <free+0x36>
    5c48:	6398                	ld	a4,0(a5)
    5c4a:	00e6e463          	bltu	a3,a4,5c52 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c4e:	fee7eae3          	bltu	a5,a4,5c42 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c52:	ff852583          	lw	a1,-8(a0)
    5c56:	6390                	ld	a2,0(a5)
    5c58:	02059713          	slli	a4,a1,0x20
    5c5c:	9301                	srli	a4,a4,0x20
    5c5e:	0712                	slli	a4,a4,0x4
    5c60:	9736                	add	a4,a4,a3
    5c62:	fae60ae3          	beq	a2,a4,5c16 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5c66:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c6a:	4790                	lw	a2,8(a5)
    5c6c:	02061713          	slli	a4,a2,0x20
    5c70:	9301                	srli	a4,a4,0x20
    5c72:	0712                	slli	a4,a4,0x4
    5c74:	973e                	add	a4,a4,a5
    5c76:	fae689e3          	beq	a3,a4,5c28 <free+0x26>
  } else
    p->s.ptr = bp;
    5c7a:	e394                	sd	a3,0(a5)
  freep = p;
    5c7c:	00003717          	auipc	a4,0x3
    5c80:	8ef73a23          	sd	a5,-1804(a4) # 8570 <freep>
}
    5c84:	6422                	ld	s0,8(sp)
    5c86:	0141                	addi	sp,sp,16
    5c88:	8082                	ret

0000000000005c8a <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5c96:	e852                	sd	s4,16(sp)
    5c98:	e456                	sd	s5,8(sp)
    5c9a:	e05a                	sd	s6,0(sp)
    5c9c:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5c9e:	02051493          	slli	s1,a0,0x20
    5ca2:	9081                	srli	s1,s1,0x20
    5ca4:	04bd                	addi	s1,s1,15
    5ca6:	8091                	srli	s1,s1,0x4
    5ca8:	0014899b          	addiw	s3,s1,1
    5cac:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cae:	00003517          	auipc	a0,0x3
    5cb2:	8c253503          	ld	a0,-1854(a0) # 8570 <freep>
    5cb6:	c515                	beqz	a0,5ce2 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cb8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cba:	4798                	lw	a4,8(a5)
    5cbc:	02977f63          	bgeu	a4,s1,5cfa <malloc+0x70>
    5cc0:	8a4e                	mv	s4,s3
    5cc2:	0009871b          	sext.w	a4,s3
    5cc6:	6685                	lui	a3,0x1
    5cc8:	00d77363          	bgeu	a4,a3,5cce <malloc+0x44>
    5ccc:	6a05                	lui	s4,0x1
    5cce:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cd2:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cd6:	00003917          	auipc	s2,0x3
    5cda:	89a90913          	addi	s2,s2,-1894 # 8570 <freep>
  if(p == (char*)-1)
    5cde:	5afd                	li	s5,-1
    5ce0:	a88d                	j	5d52 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5ce2:	00009797          	auipc	a5,0x9
    5ce6:	0ae78793          	addi	a5,a5,174 # ed90 <base>
    5cea:	00003717          	auipc	a4,0x3
    5cee:	88f73323          	sd	a5,-1914(a4) # 8570 <freep>
    5cf2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5cf4:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5cf8:	b7e1                	j	5cc0 <malloc+0x36>
      if(p->s.size == nunits)
    5cfa:	02e48b63          	beq	s1,a4,5d30 <malloc+0xa6>
        p->s.size -= nunits;
    5cfe:	4137073b          	subw	a4,a4,s3
    5d02:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d04:	1702                	slli	a4,a4,0x20
    5d06:	9301                	srli	a4,a4,0x20
    5d08:	0712                	slli	a4,a4,0x4
    5d0a:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d0c:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d10:	00003717          	auipc	a4,0x3
    5d14:	86a73023          	sd	a0,-1952(a4) # 8570 <freep>
      return (void*)(p + 1);
    5d18:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5d1c:	70e2                	ld	ra,56(sp)
    5d1e:	7442                	ld	s0,48(sp)
    5d20:	74a2                	ld	s1,40(sp)
    5d22:	7902                	ld	s2,32(sp)
    5d24:	69e2                	ld	s3,24(sp)
    5d26:	6a42                	ld	s4,16(sp)
    5d28:	6aa2                	ld	s5,8(sp)
    5d2a:	6b02                	ld	s6,0(sp)
    5d2c:	6121                	addi	sp,sp,64
    5d2e:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d30:	6398                	ld	a4,0(a5)
    5d32:	e118                	sd	a4,0(a0)
    5d34:	bff1                	j	5d10 <malloc+0x86>
  hp->s.size = nu;
    5d36:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d3a:	0541                	addi	a0,a0,16
    5d3c:	00000097          	auipc	ra,0x0
    5d40:	ec6080e7          	jalr	-314(ra) # 5c02 <free>
  return freep;
    5d44:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d48:	d971                	beqz	a0,5d1c <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d4a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d4c:	4798                	lw	a4,8(a5)
    5d4e:	fa9776e3          	bgeu	a4,s1,5cfa <malloc+0x70>
    if(p == freep)
    5d52:	00093703          	ld	a4,0(s2)
    5d56:	853e                	mv	a0,a5
    5d58:	fef719e3          	bne	a4,a5,5d4a <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5d5c:	8552                	mv	a0,s4
    5d5e:	00000097          	auipc	ra,0x0
    5d62:	b7e080e7          	jalr	-1154(ra) # 58dc <sbrk>
  if(p == (char*)-1)
    5d66:	fd5518e3          	bne	a0,s5,5d36 <malloc+0xac>
        return 0;
    5d6a:	4501                	li	a0,0
    5d6c:	bf45                	j	5d1c <malloc+0x92>
