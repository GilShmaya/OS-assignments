...
void sanityCheckFirstPart(void)
{
  ...
  80:	8b450513          	addi	a0,a0,-1868 # 930 <malloc+0xe4>
  ...
  a4:	8c050513          	addi	a0,a0,-1856 # 960 <malloc+0x114>
  a8:	00000097          	auipc	ra,0x0
  ac:	6e6080e7          	jalr	1766(ra) # 78e <printf>
  }
  ...
  cc:	8b850513          	addi	a0,a0,-1864 # 980 <malloc+0x134>
  d0:	00000097          	auipc	ra,0x0
  d4:	6be080e7          	jalr	1726(ra) # 78e <printf>
  }
  ...
  f4:	8c050513          	addi	a0,a0,-1856 # 9b0 <malloc+0x164>
  f8:	00000097          	auipc	ra,0x0
  fc:	696080e7          	jalr	1686(ra) # 78e <printf>
  }
 ...
 110:	6b8080e7          	jalr	1720(ra) # 7c4 <free>
  free(single);
 114:	854e                	mv	a0,s3
 116:	00000097          	auipc	ra,0x0
 11a:	6ae080e7          	jalr	1710(ra) # 7c4 <free>
  free(d_indirect);
 11e:	854a                	mv	a0,s2
 120:	00000097          	auipc	ra,0x0
 124:	6a4080e7          	jalr	1700(ra) # 7c4 <free>
} 
 ...
 13c:	80050513          	addi	a0,a0,-2048 # 938 <malloc+0xec>
 140:	00000097          	auipc	ra,0x0
 144:	64e080e7          	jalr	1614(ra) # 78e <printf>
    exit(0);
 148:	4501                	li	a0,0
 ...
 156:	7e650513          	addi	a0,a0,2022 # 938 <malloc+0xec>
 15a:	00000097          	auipc	ra,0x0
 15e:	634080e7          	jalr	1588(ra) # 78e <printf>
    exit(0);
 162:	4501                	li	a0,0
 ...
 170:	7cc50513          	addi	a0,a0,1996 # 938 <malloc+0xec>
...
strcpy(char *s, const char *t)
{
 ...
 1b0:	fee78fa3          	sb	a4,-1(a5) # fffff <__global_pointer$+0xfee06>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 384:	fed70fa3          	sb	a3,-1(a4) # fffff <__global_pointer$+0xfee06>
    while(n-- > 0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4fe:	4ee50513          	addi	a0,a0,1262 # 9e8 <digits>
 502:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ca:	422b8b93          	addi	s7,s7,1058 # 9e8 <digits>
 ...
 70a:	2da90913          	addi	s2,s2,730 # 9e0 <malloc+0x194>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7d2:	2327b783          	ld	a5,562(a5) # a00 <freep>
 ...
 800:	00e6ea63          	bltu	a3,a4,814 <free+0x50>
{
 ...
 842:	1cf73123          	sd	a5,450(a4) # a00 <freep>
}
 846:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 874:	19053503          	ld	a0,400(a0) # a00 <freep>
 ...
 89c:	16890913          	addi	s2,s2,360 # a00 <freep>
  if(p == (char*)-1)
 8a0:	5afd                	li	s5,-1
 8a2:	a88d                	j	914 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 8a4:	00000797          	auipc	a5,0x0
 8a8:	16478793          	addi	a5,a5,356 # a08 <base>
 8ac:	00000717          	auipc	a4,0x0
 8b0:	14f73a23          	sd	a5,340(a4) # a00 <freep>
 8b4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8d6:	12a73723          	sd	a0,302(a4) # a00 <freep>
      return (void*)(p + 1);
