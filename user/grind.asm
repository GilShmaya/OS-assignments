...
go(int which_child)
{
  ...
  char *break0 = sbrk(0);
      ...
      94:	e6e080e7          	jalr	-402(ra) # efe <sbrk>
      98:	8aaa                	mv	s5,a0
  uint64 iters = 0;
  ...
  mkdir("grindir");
      ...
      a6:	e3c080e7          	jalr	-452(ra) # ede <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2e650513          	addi	a0,a0,742 # 1390 <malloc+0xe4>
      b2:	00001097          	auipc	ra,0x1
      b6:	e34080e7          	jalr	-460(ra) # ee6 <chdir>
  ...
  chdir("/");
      ...
      e2:	e08080e7          	jalr	-504(ra) # ee6 <chdir>
  ...
  int fd = -1;
     ...
     100:	5aca0a13          	addi	s4,s4,1452 # 16a8 <buf.1244>
    ...
    if(what == 1){
     ...
     318:	bd2080e7          	jalr	-1070(ra) # ee6 <chdir>
     ...
     33a:	bb0080e7          	jalr	-1104(ra) # ee6 <chdir>
     ...
     3ce:	b14080e7          	jalr	-1260(ra) # ede <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     ...
     40c:	ad6080e7          	jalr	-1322(ra) # ede <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1244+0xd3>
     522:	00001097          	auipc	ra,0x1
     526:	9dc080e7          	jalr	-1572(ra) # efe <sbrk>
     52a:	bee5                	j	122 <go+0xaa>
      if(sbrk(0) > break0)
     52c:	4501                	li	a0,0
     52e:	00001097          	auipc	ra,0x1
     532:	9d0080e7          	jalr	-1584(ra) # efe <sbrk>
     536:	beaaf6e3          	bgeu	s5,a0,122 <go+0xaa>
        sbrk(-(sbrk(0) - break0));
     53a:	4501                	li	a0,0
     53c:	00001097          	auipc	ra,0x1
     540:	9c2080e7          	jalr	-1598(ra) # efe <sbrk>
     544:	40aa853b          	subw	a0,s5,a0
     548:	00001097          	auipc	ra,0x1
     54c:	9b6080e7          	jalr	-1610(ra) # efe <sbrk>
     ...
     56e:	97c080e7          	jalr	-1668(ra) # ee6 <chdir>
     ...
     602:	8f8080e7          	jalr	-1800(ra) # ef6 <getpid>
     ...
     932:	5c0080e7          	jalr	1472(ra) # eee <dup>
     936:	4785                	li	a5,1
     ...
     9f6:	4fc080e7          	jalr	1276(ra) # eee <dup>
     ...
     a36:	4bc080e7          	jalr	1212(ra) # eee <dup>
     a3a:	4785                	li	a5,1
...
main()
{
  ...
  while(1){
    ...
    sleep(20);
     ...
     bd2:	338080e7          	jalr	824(ra) # f06 <sleep>
    int pid = fork();
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1384:	b7e080e7          	jalr	-1154(ra) # efe <sbrk>
  if(p == (char*)-1)
