...
main()
{
  ...
  scheduler();        
    ...
    80000ee8:	1f8080e7          	jalr	504(ra) # 800020dc <scheduler>
}
...
make_acquired_process_running(struct cpu *c, struct proc *p){
  ...
  swtch(&c->context, &p->context);
    ...
    80001fca:	8b0080e7          	jalr	-1872(ra) # 80002876 <swtch>
  c->proc = 0;
...
void scheduler_sjf(void){
    80001fe8:	711d                	addi	sp,sp,-96
    80001fea:	ec86                	sd	ra,88(sp)
    80001fec:	e8a2                	sd	s0,80(sp)
    80001fee:	e4a6                	sd	s1,72(sp)
    80001ff0:	e0ca                	sd	s2,64(sp)
    80001ff2:	fc4e                	sd	s3,56(sp)
    80001ff4:	f852                	sd	s4,48(sp)
    80001ff6:	f456                	sd	s5,40(sp)
    80001ff8:	f05a                	sd	s6,32(sp)
    80001ffa:	ec5e                	sd	s7,24(sp)
    80001ffc:	e862                	sd	s8,16(sp)
    80001ffe:	e466                	sd	s9,8(sp)
    80002000:	e06a                	sd	s10,0(sp)
    80002002:	1080                	addi	s0,sp,96
  asm volatile("mv %0, tp" : "=r" (x) );
  ...
  struct cpu *c = &cpus[id];
    ...
    8000200a:	0000fb97          	auipc	s7,0xf
    8000200e:	2c6b8b93          	addi	s7,s7,710 # 800112d0 <cpus>
    80002012:	9bbe                	add	s7,s7,a5
  c->proc = 0;
    80002014:	0000f717          	auipc	a4,0xf
    80002018:	28c70713          	addi	a4,a4,652 # 800112a0 <pid_lock>
    8000201c:	97ba                	add	a5,a5,a4
    8000201e:	0207b823          	sd	zero,48(a5)
    for(curr = proc; curr < &proc[NPROC]; p++) {
    80002022:	0000fb17          	auipc	s6,0xf
    80002026:	6aeb0b13          	addi	s6,s6,1710 # 800116d0 <proc>
      if(ticks >= pause_ticks){ // check if pause signal was called
    8000202a:	00007997          	auipc	s3,0x7
    8000202e:	00e98993          	addi	s3,s3,14 # 80009038 <ticks>
    80002032:	00007a97          	auipc	s5,0x7
    80002036:	ff6a8a93          	addi	s5,s5,-10 # 80009028 <pause_ticks>
        if(curr->state == RUNNABLE) {
    8000203a:	4c0d                	li	s8,3
          curr->mean_ticks = ((SECONDS_TO_TICKS - RATE) * curr->mean_ticks + curr->last_ticks * (RATE)) / SECONDS_TO_TICKS;
    8000203c:	4ca9                	li	s9,10
    for(curr = proc; curr < &proc[NPROC]; p++) {
    8000203e:	00015a17          	auipc	s4,0x15
    80002042:	292a0a13          	addi	s4,s4,658 # 800172d0 <tickslock>
    80002046:	a89d                	j	800020bc <scheduler_sjf+0xd4>
        acquire(&curr->lock);
    80002048:	854a                	mv	a0,s2
    8000204a:	fffff097          	auipc	ra,0xfffff
    8000204e:	b9a080e7          	jalr	-1126(ra) # 80000be4 <acquire>
        if(curr->state == RUNNABLE) {
    80002052:	01892783          	lw	a5,24(s2)
    80002056:	01878a63          	beq	a5,s8,8000206a <scheduler_sjf+0x82>
        if(p != curr)
    8000205a:	03248f63          	beq	s1,s2,80002098 <scheduler_sjf+0xb0>
          release(&curr->lock);
    8000205e:	854a                	mv	a0,s2
    80002060:	fffff097          	auipc	ra,0xfffff
    80002064:	c38080e7          	jalr	-968(ra) # 80000c98 <release>
    80002068:	a885                	j	800020d8 <scheduler_sjf+0xf0>
          curr->mean_ticks = ((SECONDS_TO_TICKS - RATE) * curr->mean_ticks + curr->last_ticks * (RATE)) / SECONDS_TO_TICKS;
    8000206a:	03492703          	lw	a4,52(s2)
    8000206e:	0027179b          	slliw	a5,a4,0x2
    80002072:	9fb9                	addw	a5,a5,a4
    80002074:	0017979b          	slliw	a5,a5,0x1
    80002078:	0397d7bb          	divuw	a5,a5,s9
    8000207c:	0007871b          	sext.w	a4,a5
    80002080:	02f92a23          	sw	a5,52(s2)
          if(p == NULL){
    80002084:	c881                	beqz	s1,80002094 <scheduler_sjf+0xac>
          } else if(p->mean_ticks > curr->mean_ticks) {
    80002086:	58dc                	lw	a5,52(s1)
    80002088:	fcf779e3          	bgeu	a4,a5,8000205a <scheduler_sjf+0x72>
    8000208c:	87a6                	mv	a5,s1
    8000208e:	84ca                	mv	s1,s2
    80002090:	893e                	mv	s2,a5
    80002092:	b7e1                	j	8000205a <scheduler_sjf+0x72>
    80002094:	84ca                	mv	s1,s2
    80002096:	a011                	j	8000209a <scheduler_sjf+0xb2>
        if(p != curr)
    80002098:	84ca                	mv	s1,s2
        uint start = ticks;
    8000209a:	0009ad03          	lw	s10,0(s3)
        make_acquired_process_running(c, p);
    8000209e:	85a6                	mv	a1,s1
    800020a0:	855e                	mv	a0,s7
    800020a2:	00000097          	auipc	ra,0x0
    800020a6:	f08080e7          	jalr	-248(ra) # 80001faa <make_acquired_process_running>
        p->last_ticks = ticks - start;
    800020aa:	0009a783          	lw	a5,0(s3)
    800020ae:	41a787bb          	subw	a5,a5,s10
    800020b2:	dc9c                	sw	a5,56(s1)
    for(curr = proc; curr < &proc[NPROC]; p++) {
    800020b4:	17048493          	addi	s1,s1,368
    800020b8:	01496a63          	bltu	s2,s4,800020cc <scheduler_sjf+0xe4>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800020c8:	895a                	mv	s2,s6
    p = NULL;
    800020ca:	4481                	li	s1,0
      if(ticks >= pause_ticks){ // check if pause signal was called
    800020cc:	0009a703          	lw	a4,0(s3)
    800020d0:	000aa783          	lw	a5,0(s5)
    800020d4:	f6f77ae3          	bgeu	a4,a5,80002048 <scheduler_sjf+0x60>
      if(p != NULL){
    800020d8:	dcf1                	beqz	s1,800020b4 <scheduler_sjf+0xcc>
    800020da:	b7c1                	j	8000209a <scheduler_sjf+0xb2>
...
00000000800020dc <scheduler>:
{
    ...
    800020e8:	13450513          	addi	a0,a0,308 # 80008218 <digits+0x1d8>
    800020ec:	ffffe097          	auipc	ra,0xffffe
    800020f0:	49c080e7          	jalr	1180(ra) # 80000588 <printf>
    scheduler_sjf();
    800020f4:	00000097          	auipc	ra,0x0
    800020f8:	ef4080e7          	jalr	-268(ra) # 80001fe8 <scheduler_sjf>

00000000800020fc <scheduler_fcfs>:
scheduler_fcfs(void) {
  ...
  struct cpu *c = &cpus[id];
    ...
    8000211a:	0000fb97          	auipc	s7,0xf
    8000211e:	1b6b8b93          	addi	s7,s7,438 # 800112d0 <cpus>
    80002122:	9bbe                	add	s7,s7,a5
  c->proc = 0;
    80002124:	0000f717          	auipc	a4,0xf
    80002128:	17c70713          	addi	a4,a4,380 # 800112a0 <pid_lock>
    8000212c:	97ba                	add	a5,a5,a4
    8000212e:	0207b823          	sd	zero,48(a5)
    for(curr = proc; curr < &proc[NPROC]; p++) {
    80002132:	0000fb17          	auipc	s6,0xf
    80002136:	59eb0b13          	addi	s6,s6,1438 # 800116d0 <proc>
      if(ticks >= pause_ticks){ // check if pause signal was called
    8000213a:	00007a97          	auipc	s5,0x7
    8000213e:	efea8a93          	addi	s5,s5,-258 # 80009038 <ticks>
    80002142:	00007a17          	auipc	s4,0x7
    80002146:	ee6a0a13          	addi	s4,s4,-282 # 80009028 <pause_ticks>
        if(curr->state == RUNNABLE) {
    8000214a:	4c0d                	li	s8,3
    for(curr = proc; curr < &proc[NPROC]; p++) {
    8000214c:	00015997          	auipc	s3,0x15
    80002150:	18498993          	addi	s3,s3,388 # 800172d0 <tickslock>
    80002154:	a889                	j	800021a6 <scheduler_fcfs+0xaa>
        acquire(&curr->lock);
    80002156:	854a                	mv	a0,s2
    80002158:	fffff097          	auipc	ra,0xfffff
    8000215c:	a8c080e7          	jalr	-1396(ra) # 80000be4 <acquire>
        if(curr->state == RUNNABLE) {
    80002160:	01892783          	lw	a5,24(s2)
    80002164:	01878a63          	beq	a5,s8,80002178 <scheduler_fcfs+0x7c>
        if(p != curr)
    80002168:	03248463          	beq	s1,s2,80002190 <scheduler_fcfs+0x94>
          release(&curr->lock);
    8000216c:	854a                	mv	a0,s2
    8000216e:	fffff097          	auipc	ra,0xfffff
    80002172:	b2a080e7          	jalr	-1238(ra) # 80000c98 <release>
    80002176:	a0b1                	j	800021c2 <scheduler_fcfs+0xc6>
          if(p == NULL){
    80002178:	c891                	beqz	s1,8000218c <scheduler_fcfs+0x90>
          } else if(p->last_runnable_time > curr->last_runnable_time) {
    8000217a:	5cd8                	lw	a4,60(s1)
    8000217c:	03c92783          	lw	a5,60(s2)
    80002180:	fee7f4e3          	bgeu	a5,a4,80002168 <scheduler_fcfs+0x6c>
    80002184:	87a6                	mv	a5,s1
    80002186:	84ca                	mv	s1,s2
    80002188:	893e                	mv	s2,a5
    8000218a:	bff9                	j	80002168 <scheduler_fcfs+0x6c>
    8000218c:	84ca                	mv	s1,s2
    8000218e:	a011                	j	80002192 <scheduler_fcfs+0x96>
        if(p != curr)
    80002190:	84ca                	mv	s1,s2
        make_acquired_process_running(c, p);
    80002192:	85a6                	mv	a1,s1
    80002194:	855e                	mv	a0,s7
    80002196:	00000097          	auipc	ra,0x0
    8000219a:	e14080e7          	jalr	-492(ra) # 80001faa <make_acquired_process_running>
    for(curr = proc; curr < &proc[NPROC]; p++) {
    8000219e:	17048493          	addi	s1,s1,368
    800021a2:	01396a63          	bltu	s2,s3,800021b6 <scheduler_fcfs+0xba>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    p = NULL;
    800021b4:	4481                	li	s1,0
      if(ticks >= pause_ticks){ // check if pause signal was called
    800021b6:	000aa703          	lw	a4,0(s5)
    800021ba:	000a2783          	lw	a5,0(s4)
    800021be:	f8f77ce3          	bgeu	a4,a5,80002156 <scheduler_fcfs+0x5a>
      if(p != NULL){
    800021c2:	dcf1                	beqz	s1,8000219e <scheduler_fcfs+0xa2>
    800021c4:	b7f9                	j	80002192 <scheduler_fcfs+0x96>
