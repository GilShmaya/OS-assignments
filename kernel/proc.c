...
uint pause_ticks = 0; // indicates the number of tick that need to wait in case pause is called 
...
int
get_mean(int last_mean, int curr_time, int num_procs)
{
